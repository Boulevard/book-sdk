...
export type SendClientAuthorizationCodeViaSmsMutation = {
  ...
  sendClientAuthorizationCodeViaSms?: Maybe<
    { __typename?: "SendClientAuthorizationCodeViaSmsPayload" } & Pick<
      SendClientAuthorizationCodeViaSmsPayload,
...
export const SendClientAuthorizationCodeViaSms = gql`
  mutation SendClientAuthorizationCodeViaSms(
    $input: SendClientAuthorizationCodeViaSmsInput!
  ) {
...
export function getSdk(
  ...
  return {
    SendClientAuthorizationCodeViaSms(
      variables: SendClientAuthorizationCodeViaSmsMutationVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<SendClientAuthorizationCodeViaSmsMutation> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<SendClientAuthorizationCodeViaSmsMutation>(
            SendClientAuthorizationCodeViaSmsDocument,
            variables,
