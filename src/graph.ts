...
export type SendCartOwnershipCodeBySmsMutation = {
  ...
  sendCartOwnershipCodeBySms?: Maybe<
    { __typename?: "SendCartOwnershipCodeBySmsPayload" } & Pick<
...
export type SendCartOwnershipCodeByEmailMutation = {
  ...
  sendCartOwnershipCodeByEmail?: Maybe<
    { __typename?: "SendCartOwnershipCodeByEmailPayload" } & Pick<
...
export function getSdk(
  ...
  return {
    sendCartOwnershipCodeBySms(
      variables: SendCartOwnershipCodeBySmsMutationVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<SendCartOwnershipCodeBySmsMutation> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<SendCartOwnershipCodeBySmsMutation>(
            SendCartOwnershipCodeBySmsDocument,
            variables,
    ...
    sendCartOwnershipCodeByEmail(
      variables: SendCartOwnershipCodeByEmailMutationVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<SendCartOwnershipCodeByEmailMutation> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<SendCartOwnershipCodeByEmailMutation>(
            SendCartOwnershipCodeByEmailDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "sendCartOwnershipCodeByEmail"
    ...
    takeCartOwnershipByCode(
      variables: TakeCartOwnershipByCodeMutationVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<TakeCartOwnershipByCodeMutation> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<TakeCartOwnershipByCodeMutation>(
            TakeCartOwnershipByCodeDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        "takeCartOwnershipByCode"
...
export const anAddCartCardPaymentMethodInput = (
  overrides?: Partial<AddCartCardPaymentMethodInput>
): AddCartCardPaymentMethodInput => {
  return {
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "5dd6869c-15b0-441e-9221-c1b617715162",
    select:
    ...
    token:
      overrides && overrides.hasOwnProperty("token")
        ? overrides.token!
        : "e2f84ae2-28e6-492e-8a85-9b6588c5f157"
  };
};

export const anAddCartCardPaymentMethodPayload = (
  overrides?: Partial<AddCartCardPaymentMethodPayload>
...
export const anAddCartOfferInput = (
  overrides?: Partial<AddCartOfferInput>
): AddCartOfferInput => {
  return {
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "1f4f839f-de0d-442c-86da-5e08f668a1e3",
    offerCode:
      overrides && overrides.hasOwnProperty("offerCode")
        ? overrides.offerCode!
        : "non"
  };
};

export const anAddCartOfferPayload = (
  overrides?: Partial<AddCartOfferPayload>
): AddCartOfferPayload => {
  return {
    cart:
      overrides && overrides.hasOwnProperty("cart") ? overrides.cart! : aCart(),
    offer:
      overrides && overrides.hasOwnProperty("offer")
        ? overrides.offer!
        : aCartOffer()
  };
};

export const anAddCartSelectedBookableItemInput = (
  overrides?: Partial<AddCartSelectedBookableItemInput>
): AddCartSelectedBookableItemInput => {
  return {
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "2924d7d6-584f-46e7-9a54-e23e76057b17",
    itemDiscountCode:
      overrides && overrides.hasOwnProperty("itemDiscountCode")
        ? overrides.itemDiscountCode!
        : "debitis",
    itemGuestId:
      overrides && overrides.hasOwnProperty("itemGuestId")
        ? overrides.itemGuestId!
        : "8f1bf3a0-2aaa-45ff-9eab-55bf1748d47a",
    itemId:
      overrides && overrides.hasOwnProperty("itemId")
        ? overrides.itemId!
        : "5f97081f-3719-48e3-b365-36004dd1e812",
    itemOptionIds:
      overrides && overrides.hasOwnProperty("itemOptionIds")
        ? overrides.itemOptionIds!
        : ["2329067c-5a98-4e38-8405-1e479d05f057"],
    itemStaffVariantId:
      overrides && overrides.hasOwnProperty("itemStaffVariantId")
        ? overrides.itemStaffVariantId!
        : "b01853f0-a0db-4554-bca6-8a069e3787b9"
  };
};

export const anAddCartSelectedBookableItemPayload = (
  overrides?: Partial<AddCartSelectedBookableItemPayload>
...
export const anAddCartSelectedGiftCardItemInput = (
  overrides?: Partial<AddCartSelectedGiftCardItemInput>
): AddCartSelectedGiftCardItemInput => {
  return {
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "af75ff4d-07ad-43fa-a29b-cf57ab2c5a21",
    itemId:
      overrides && overrides.hasOwnProperty("itemId")
        ? overrides.itemId!
        : "1eb57a5a-085f-4262-a007-1dadaccad074",
    itemPrice:
      overrides && overrides.hasOwnProperty("itemPrice")
        ? overrides.itemPrice!
        : "nam"
  };
};

export const anAddCartSelectedGiftCardItemPayload = (
  overrides?: Partial<AddCartSelectedGiftCardItemPayload>
...
export const anAddCartSelectedPurchasableItemInput = (
  overrides?: Partial<AddCartSelectedPurchasableItemInput>
): AddCartSelectedPurchasableItemInput => {
  return {
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "9cbf379c-88e4-47ca-923a-4a4bcdbc2888",
    itemDiscountCode:
      overrides && overrides.hasOwnProperty("itemDiscountCode")
        ? overrides.itemDiscountCode!
        : "illo",
    itemId:
      overrides && overrides.hasOwnProperty("itemId")
        ? overrides.itemId!
        : "1fa32b2f-9ce7-4d51-b815-30b80663fb25"
  };
};

export const anAddCartSelectedPurchasableItemPayload = (
  overrides?: Partial<AddCartSelectedPurchasableItemPayload>
...
export const anAddress = (overrides?: Partial<Address>): Address => {
  return {
    city:
      overrides && overrides.hasOwnProperty("city") ? overrides.city! : "amet",
    country:
      overrides && overrides.hasOwnProperty("country")
        ? overrides.country!
        : "non",
    line1:
      overrides && overrides.hasOwnProperty("line1")
        ? overrides.line1!
        : "beatae",
    line2:
      overrides && overrides.hasOwnProperty("line2")
        ? overrides.line2!
        : "itaque",
    province:
...
export const anAppointment = (
  ...
  return {
    appointmentServiceOptions:
      overrides && overrides.hasOwnProperty("appointmentServiceOptions")
        ? overrides.appointmentServiceOptions!
        : [anAppointmentServiceOption()],
    appointmentServices:
      overrides && overrides.hasOwnProperty("appointmentServices")
        ? overrides.appointmentServices!
        : [anAppointmentService()],
    calendarLinks:
      overrides && overrides.hasOwnProperty("calendarLinks")
        ? overrides.calendarLinks!
        : aCalendarLinks(),
    cancellable:
      overrides && overrides.hasOwnProperty("cancellable")
        ? overrides.cancellable!
        : true,
    cancellation:
      overrides && overrides.hasOwnProperty("cancellation")
        ? overrides.cancellation!
        : anAppointmentCancellation(),
    cancelled:
      overrides && overrides.hasOwnProperty("cancelled")
        ? overrides.cancelled!
        : true,
    client:
      overrides && overrides.hasOwnProperty("client")
        ? overrides.client!
        : aClient(),
    clientDuration:
      overrides && overrides.hasOwnProperty("clientDuration")
        ? overrides.clientDuration!
        : 9520,
    clientId:
      overrides && overrides.hasOwnProperty("clientId")
        ? overrides.clientId!
        : "d1e8b066-c7b5-4c7b-a148-0b819fd27b2f",
    confirmable:
      overrides && overrides.hasOwnProperty("confirmable")
        ? overrides.confirmable!
        : false,
    createdAt:
      overrides && overrides.hasOwnProperty("createdAt")
        ...
        : "ea",
    creditCards:
      overrides && overrides.hasOwnProperty("creditCards")
        ? overrides.creditCards!
        : [aCreditCard()],
    customForms:
      overrides && overrides.hasOwnProperty("customForms")
    ...
    duration:
      overrides && overrides.hasOwnProperty("duration")
        ...
        : 2893,
    endAt:
      overrides && overrides.hasOwnProperty("endAt") ? overrides.endAt! : "rem",
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "746c73a0-8eae-47e7-a1b2-bcf2b2a0994f",
    isGroup:
      overrides && overrides.hasOwnProperty("isGroup")
        ? overrides.isGroup!
        : false,
    isRecurring:
      overrides && overrides.hasOwnProperty("isRecurring")
    ...
    location:
      overrides && overrides.hasOwnProperty("location")
        ...
        : aLocation(),
    locationId:
      overrides && overrides.hasOwnProperty("locationId")
        ? overrides.locationId!
        : "4d2d5ed1-5d55-4a9c-b05e-2cf090b04005",
    nonReschedulableReason:
      overrides && overrides.hasOwnProperty("nonReschedulableReason")
        ? overrides.nonReschedulableReason!
        : AppointmentNonReschedulableReason.CancelledAppointment,
    notes:
      overrides && overrides.hasOwnProperty("notes")
        ? overrides.notes!
        : "deleniti",
    pendingFormTemplates:
      overrides && overrides.hasOwnProperty("pendingFormTemplates")
        ? overrides.pendingFormTemplates!
        : [aCustomFormTemplate()],
    reschedulable:
      overrides && overrides.hasOwnProperty("reschedulable")
        ? overrides.reschedulable!
        : true,
    startAt:
      overrides && overrides.hasOwnProperty("startAt")
        ? overrides.startAt!
        : "ut",
    state:
      overrides && overrides.hasOwnProperty("state")
...
export const anAppointmentAddTagsInput = (
  overrides?: Partial<AppointmentAddTagsInput>
): AppointmentAddTagsInput => {
  return {
    cartId:
      overrides && overrides.hasOwnProperty("cartId")
        ? overrides.cartId!
        : "f85f788b-9049-4c50-a205-c544729299cf",
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "d6772139-d0a2-4c3f-b886-4c60f159b749",
    tagIds:
      overrides && overrides.hasOwnProperty("tagIds")
        ? overrides.tagIds!
        : ["efb89cf9-b9e5-4f2d-b443-75f35e26e41c"]
  };
};

export const anAppointmentAddTagsPayload = (
  overrides?: Partial<AppointmentAddTagsPayload>
...
export const anAppointmentCancellation = (
  overrides?: Partial<AppointmentCancellation>
): AppointmentCancellation => {
  return {
    cancelledAt:
      overrides && overrides.hasOwnProperty("cancelledAt")
    ...
    reason:
      overrides && overrides.hasOwnProperty("reason")
        ? overrides.reason!
        : AppointmentCancellationReason.ClientCancel
  };
};

export const anAppointmentConnection = (
  overrides?: Partial<AppointmentConnection>
...
export const anAppointmentEdge = (
  overrides?: Partial<AppointmentEdge>
): AppointmentEdge => {
  return {
    cursor:
...
export const anAppointmentRescheduleAvailableDatesInput = (
  overrides?: Partial<AppointmentRescheduleAvailableDatesInput>
): AppointmentRescheduleAvailableDatesInput => {
  return {
    appointmentId:
      overrides && overrides.hasOwnProperty("appointmentId")
        ? overrides.appointmentId!
        : "b699ec2a-811a-4d7e-b1ac-d2367ac38156",
    searchRangeLower:
      overrides && overrides.hasOwnProperty("searchRangeLower")
        ? overrides.searchRangeLower!
        : "1970-07-15",
    searchRangeUpper:
      overrides && overrides.hasOwnProperty("searchRangeUpper")
        ? overrides.searchRangeUpper!
        : "2006-08-28",
    tz:
      overrides && overrides.hasOwnProperty("tz")
        ? overrides.tz!
        : "reprehenderit"
  };
};

export const anAppointmentRescheduleAvailableDatesPayload = (
  overrides?: Partial<AppointmentRescheduleAvailableDatesPayload>
): AppointmentRescheduleAvailableDatesPayload => {
  return {
    availableDates:
      overrides && overrides.hasOwnProperty("availableDates")
        ? overrides.availableDates!
        : [anAvailableRescheduleDate()]
  };
};

export const anAppointmentRescheduleAvailableTimesInput = (
  overrides?: Partial<AppointmentRescheduleAvailableTimesInput>
): AppointmentRescheduleAvailableTimesInput => {
  return {
    appointmentId:
      overrides && overrides.hasOwnProperty("appointmentId")
        ? overrides.appointmentId!
        : "b1a785fd-9210-4d37-9f24-fcd69eb00c0b",
    date:
...
export const anAppointmentRescheduleAvailableTimesPayload = (
  overrides?: Partial<AppointmentRescheduleAvailableTimesPayload>
): AppointmentRescheduleAvailableTimesPayload => {
  return {
    availableTimes:
      overrides && overrides.hasOwnProperty("availableTimes")
        ? overrides.availableTimes!
        : [anAvailableRescheduleTime()]
  };
};

export const anAppointmentRescheduleInput = (
  overrides?: Partial<AppointmentRescheduleInput>
): AppointmentRescheduleInput => {
  return {
    appointmentId:
      overrides && overrides.hasOwnProperty("appointmentId")
        ? overrides.appointmentId!
        : "2e4e843f-1673-467d-a3aa-a36ecc385516",
    bookableTimeId:
      overrides && overrides.hasOwnProperty("bookableTimeId")
        ? overrides.bookableTimeId!
        : "28e2b239-d297-464a-9667-98a63923bcaa",
    sendNotification:
      overrides && overrides.hasOwnProperty("sendNotification")
        ? overrides.sendNotification!
        : false
  };
};

export const anAppointmentReschedulePayload = (
  overrides?: Partial<AppointmentReschedulePayload>
): AppointmentReschedulePayload => {
  return {
    appointment:
      overrides && overrides.hasOwnProperty("appointment")
        ? overrides.appointment!
        : anAppointment()
  };
};

export const anAppointmentService = (
  overrides?: Partial<AppointmentService>
): AppointmentService => {
  return {
    duration:
      overrides && overrides.hasOwnProperty("duration")
        ...
        : 7365,
    endAt:
      overrides && overrides.hasOwnProperty("endAt") ? overrides.endAt! : "sit",
    price:
      overrides && overrides.hasOwnProperty("price")
        ? overrides.price!
        : "rerum",
    service:
      overrides && overrides.hasOwnProperty("service")
        ? overrides.service!
        : aService(),
    serviceId:
      overrides && overrides.hasOwnProperty("serviceId")
        ? overrides.serviceId!
        : "f7ecb84d-fbe0-4c4f-9d36-9b724982eb85",
    staff:
      overrides && overrides.hasOwnProperty("staff")
        ? overrides.staff!
        : aStaff(),
    staffId:
      overrides && overrides.hasOwnProperty("staffId")
        ? overrides.staffId!
        : "b404d686-3ce5-4255-8382-6c7b6e35da22",
    staffRequested:
      overrides && overrides.hasOwnProperty("staffRequested")
        ? overrides.staffRequested!
        : true,
    startAt:
      overrides && overrides.hasOwnProperty("startAt")
        ? overrides.startAt!
        : "magni",
    startTimeOffset:
      overrides && overrides.hasOwnProperty("startTimeOffset")
        ? overrides.startTimeOffset!
        : 2448,
    totalDuration:
      overrides && overrides.hasOwnProperty("totalDuration")
        ? overrides.totalDuration!
        : 7950
  };
};

export const anAppointmentServiceOption = (
  overrides?: Partial<AppointmentServiceOption>
): AppointmentServiceOption => {
  return {
    appointmentServiceId:
      overrides && overrides.hasOwnProperty("appointmentServiceId")
        ? overrides.appointmentServiceId!
        : "d5320ef6-6e9f-49f5-9c58-5cfbb0239f6a",
    durationDelta:
      overrides && overrides.hasOwnProperty("durationDelta")
        ? overrides.durationDelta!
        : 9240,
    finishDurationDelta:
      overrides && overrides.hasOwnProperty("finishDurationDelta")
        ? overrides.finishDurationDelta!
        : 231,
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "2c298b23-9b8d-44b9-bee7-1fadb8638f66",
    postClientDurationDelta:
      overrides && overrides.hasOwnProperty("postClientDurationDelta")
        ? overrides.postClientDurationDelta!
        : 4994,
    postStaffDurationDelta:
      overrides && overrides.hasOwnProperty("postStaffDurationDelta")
        ? overrides.postStaffDurationDelta!
        : 5931,
    priceDelta:
      overrides && overrides.hasOwnProperty("priceDelta")
        ? overrides.priceDelta!
        : 6007,
    serviceOptionId:
      overrides && overrides.hasOwnProperty("serviceOptionId")
        ? overrides.serviceOptionId!
        : "00a015e9-d6e4-4398-976a-36224e1ac6cd"
  };
};

export const anAppointmentSort = (
  overrides?: Partial<AppointmentSort>
): AppointmentSort => {
  return {
    direction:
...
export const anAuthMethod = (overrides?: Partial<AuthMethod>): AuthMethod => {
  return {
    ...
    label:
      overrides && overrides.hasOwnProperty("label") ? overrides.label! : "ea",
    value:
...
export const anAvailableRescheduleDate = (
  overrides?: Partial<AvailableRescheduleDate>
...
export const anAvailableRescheduleTime = (
  overrides?: Partial<AvailableRescheduleTime>
): AvailableRescheduleTime => {
  return {
    bookableTimeId:
      overrides && overrides.hasOwnProperty("bookableTimeId")
        ? overrides.bookableTimeId!
        : "61d361f7-0cff-48a4-9a45-0b51b581adb7",
    startTime:
...
export const aBaseBookableItem = (
  overrides?: Partial<BaseBookableItem>
): BaseBookableItem => {
  return {
    itemId:
      overrides && overrides.hasOwnProperty("itemId")
        ? overrides.itemId!
        : "c7553a7c-a94d-4cbe-aa9b-f4f9df43c485",
    sameStaffVariantRequired:
      overrides && overrides.hasOwnProperty("sameStaffVariantRequired")
        ? overrides.sameStaffVariantRequired!
        : false
  };
};

export const aBookingQuestionOptionAnswerInput = (
  overrides?: Partial<BookingQuestionOptionAnswerInput>
): BookingQuestionOptionAnswerInput => {
  return {
    optionId:
      overrides && overrides.hasOwnProperty("optionId")
        ? overrides.optionId!
        : "84ecae13-053c-40f8-99a1-182e51a11954"
  };
};
...
export const aBusiness = (overrides?: Partial<Business>): Business => {
  return {
    allowLoginWithMultipleClients:
      overrides && overrides.hasOwnProperty("allowLoginWithMultipleClients")
        ? overrides.allowLoginWithMultipleClients!
        : false,
    avatar:
      overrides && overrides.hasOwnProperty("avatar")
        ...
        : "quod",
    customBookingUrl:
      overrides && overrides.hasOwnProperty("customBookingUrl")
        ? overrides.customBookingUrl!
        : "ut",
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "a2f7ba36-84f2-49e7-a518-ec0b59b44903",
    insertedAt:
      overrides && overrides.hasOwnProperty("insertedAt")
        ? overrides.insertedAt!
        : "qui",
    locations:
      overrides && overrides.hasOwnProperty("locations")
        ? overrides.locations!
        : aLocationConnection(),
    manageReferralSourcesByLocation:
      overrides && overrides.hasOwnProperty("manageReferralSourcesByLocation")
        ? overrides.manageReferralSourcesByLocation!
        : true,
    name:
    ...
    onlineGiftCardSettings:
      overrides && overrides.hasOwnProperty("onlineGiftCardSettings")
        ? overrides.onlineGiftCardSettings!
        : anOnlineGiftCardSettings(),
    phoneNumber:
      overrides && overrides.hasOwnProperty("phoneNumber")
        ? overrides.phoneNumber!
        : "qui",
    referralSources:
      overrides && overrides.hasOwnProperty("referralSources")
        ? overrides.referralSources!
        : [aReferralSource()],
    ...
    updatedAt:
      overrides && overrides.hasOwnProperty("updatedAt")
        ...
        : "ducimus",
    website:
      overrides && overrides.hasOwnProperty("website")
        ? overrides.website!
        : "molestias"
  };
};

export const aBusinessGiftCardDesign = (
  overrides?: Partial<BusinessGiftCardDesign>
): BusinessGiftCardDesign => {
  return {
    design:
      overrides && overrides.hasOwnProperty("design")
        ? overrides.design!
        : aGiftCardDesign(),
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "752cd2fa-ae1a-459e-ae72-6a3b125a1b95",
    selected:
      overrides && overrides.hasOwnProperty("selected")
        ? overrides.selected!
        : true
  };
};

export const aCalendarLinks = (
  overrides?: Partial<CalendarLinks>
): CalendarLinks => {
  return {
    googleCalendar:
      overrides && overrides.hasOwnProperty("googleCalendar")
        ? overrides.googleCalendar!
        : "beatae",
    icsDownload:
      overrides && overrides.hasOwnProperty("icsDownload")
        ? overrides.icsDownload!
        : "totam",
    microsoftOffice:
      overrides && overrides.hasOwnProperty("microsoftOffice")
        ? overrides.microsoftOffice!
        : "autem",
    microsoftOutlook:
      overrides && overrides.hasOwnProperty("microsoftOutlook")
        ? overrides.microsoftOutlook!
        : "occaecati",
    yahooCalendar:
      overrides && overrides.hasOwnProperty("yahooCalendar")
        ? overrides.yahooCalendar!
        : "nobis"
  };
};

export const aCancelAppointmentInput = (
  overrides?: Partial<CancelAppointmentInput>
): CancelAppointmentInput => {
  return {
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "1e219241-a60f-411e-af71-63f2f6b2a81c",
    notes:
      overrides && overrides.hasOwnProperty("notes")
        ? overrides.notes!
        : "earum"
...
export const aCancelAppointmentPayload = (
  overrides?: Partial<CancelAppointmentPayload>
...
export const aCart = (overrides?: Partial<Cart>): Cart => {
  return {
    advanceGratuity:
      overrides && overrides.hasOwnProperty("advanceGratuity")
        ? overrides.advanceGratuity!
        : aCartAdvanceGratuity(),
    availableCategories:
      overrides && overrides.hasOwnProperty("availableCategories")
        ? overrides.availableCategories!
        : [aCartAvailableCategory()],
    availableItem:
      overrides && overrides.hasOwnProperty("availableItem")
        ? overrides.availableItem!
        : aCartAvailableItem(),
    availablePaymentMethods:
      overrides && overrides.hasOwnProperty("availablePaymentMethods")
        ? overrides.availablePaymentMethods!
        : [aCartItemPaymentMethod()],
    bookingQuestions:
      overrides && overrides.hasOwnProperty("bookingQuestions")
        ? overrides.bookingQuestions!
        : [aCartBookingQuestion()],
    clientInformation:
      overrides && overrides.hasOwnProperty("clientInformation")
        ? overrides.clientInformation!
        : aCartClientInformation(),
    clientMessage:
      overrides && overrides.hasOwnProperty("clientMessage")
        ? overrides.clientMessage!
        : "ea",
    completedAt:
    ...
    expiresAt:
      overrides && overrides.hasOwnProperty("expiresAt")
        ...
        : "aut",
    features:
      overrides && overrides.hasOwnProperty("features")
        ? overrides.features!
        : aCartFeatures(),
    guests:
      overrides && overrides.hasOwnProperty("guests")
        ? overrides.guests!
        : [aCartGuest()],
    id:
      overrides && overrides.hasOwnProperty("id")
    ...
    location:
      overrides && overrides.hasOwnProperty("location")
        ...
        : aLocation(),
    offers:
      overrides && overrides.hasOwnProperty("offers")
        ? overrides.offers!
        : [aCartOffer()],
    selectedItem:
      overrides && overrides.hasOwnProperty("selectedItem")
        ? overrides.selectedItem!
        : aCartItem(),
    selectedItems:
      overrides && overrides.hasOwnProperty("selectedItems")
    ...
    startTime:
      overrides && overrides.hasOwnProperty("startTime")
        ...
        : "magni",
    startTimeId:
      overrides && overrides.hasOwnProperty("startTimeId")
        ? overrides.startTimeId!
        : "9f173804-87b8-47ec-9ff3-5ab6e9da9fc3",
    summary:
      overrides && overrides.hasOwnProperty("summary")
        ? overrides.summary!
        : aCartSummary(),
    updatedAt:
      overrides && overrides.hasOwnProperty("updatedAt")
...
export const aCartAddToWaitlistInput = (
  overrides?: Partial<CartAddToWaitlistInput>
): CartAddToWaitlistInput => {
  return {
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "09ce8d80-da71-4fea-a812-f6cc18db62df",
    preferredTimeLower:
      overrides && overrides.hasOwnProperty("preferredTimeLower")
        ? overrides.preferredTimeLower!
        : "aut",
    preferredTimeUpper:
      overrides && overrides.hasOwnProperty("preferredTimeUpper")
        ? overrides.preferredTimeUpper!
        : "maxime",
    tz: overrides && overrides.hasOwnProperty("tz") ? overrides.tz! : "animi"
  };
};

export const aCartAddToWaitlistPayload = (
  overrides?: Partial<CartAddToWaitlistPayload>
...
export const aCartAdvanceGratuity = (
  overrides?: Partial<CartAdvanceGratuity>
): CartAdvanceGratuity => {
  return {
    fixed:
      overrides && overrides.hasOwnProperty("fixed")
        ? overrides.fixed!
        : "veniam",
    percentage:
...
export const aCartAdvanceGratuityInput = (
  overrides?: Partial<CartAdvanceGratuityInput>
...
export const aCartAppointment = (
  overrides?: Partial<CartAppointment>
): CartAppointment => {
  return {
    appointmentId:
      overrides && overrides.hasOwnProperty("appointmentId")
        ? overrides.appointmentId!
        : "d2416b4e-4af9-4dee-909f-e7be31e1fb34",
    clientId:
      overrides && overrides.hasOwnProperty("clientId")
        ? overrides.clientId!
        : "0f384a23-d72a-4cbe-80f5-e926c2ecbd10",
    forCartOwner:
      overrides && overrides.hasOwnProperty("forCartOwner")
        ? overrides.forCartOwner!
        : false
  };
};

export const aCartAvailableBookableItem = (
  overrides?: Partial<CartAvailableBookableItem>
  ...
  return {
    description:
      overrides && overrides.hasOwnProperty("description")
        ...
        : "a",
    disabled:
      overrides && overrides.hasOwnProperty("disabled")
        ? overrides.disabled!
        : true,
    disabledDescription:
      overrides && overrides.hasOwnProperty("disabledDescription")
        ? overrides.disabledDescription!
        : "quia",
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "79531cd2-de03-4ac4-bdcc-ea3b8d4d6451",
    listDuration:
      overrides && overrides.hasOwnProperty("listDuration")
        ? overrides.listDuration!
        : 7765,
    listDurationRange:
      overrides && overrides.hasOwnProperty("listDurationRange")
        ? overrides.listDurationRange!
        : aCartDurationRange(),
    listPrice:
      overrides && overrides.hasOwnProperty("listPrice")
        ? overrides.listPrice!
        : "non",
    listPriceRange:
      overrides && overrides.hasOwnProperty("listPriceRange")
        ? overrides.listPriceRange!
        : aCartPriceRange(),
    locationVariants:
      overrides && overrides.hasOwnProperty("locationVariants")
        ? overrides.locationVariants!
        : [aCartAvailableBookableItemLocationVariant()],
    name:
      overrides && overrides.hasOwnProperty("name")
        ? overrides.name!
        : "magnam",
    optionGroups:
      overrides && overrides.hasOwnProperty("optionGroups")
        ? overrides.optionGroups!
        : [aCartAvailableBookableItemOptionGroup()],
    staffVariants:
      overrides && overrides.hasOwnProperty("staffVariants")
        ? overrides.staffVariants!
        : [aCartAvailableBookableItemStaffVariant()],
    variableDuration:
      overrides && overrides.hasOwnProperty("variableDuration")
        ? overrides.variableDuration!
        : false,
    variablePrice:
      overrides && overrides.hasOwnProperty("variablePrice")
        ? overrides.variablePrice!
        : false
  };
};

export const aCartAvailableBookableItemLocationVariant = (
  overrides?: Partial<CartAvailableBookableItemLocationVariant>
...
export const aCartAvailableBookableItemOption = (
  overrides?: Partial<CartAvailableBookableItemOption>
  ...
  return {
    ...
    durationDelta:
      overrides && overrides.hasOwnProperty("durationDelta")
        ...
        : 9113,
    groupId:
      overrides && overrides.hasOwnProperty("groupId")
        ? overrides.groupId!
        : "c454717e-a849-41a4-84bb-bcdcdb77da0e",
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "90910e46-79cc-4f97-a2b9-ab8e83743ec4",
    name:
...
export const aCartAvailableBookableItemOptionGroup = (
  overrides?: Partial<CartAvailableBookableItemOptionGroup>
  ...
  return {
    ...
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "460f24eb-9c5a-4d90-b55d-f0bf9c3c0828",
    maxLimit:
      overrides && overrides.hasOwnProperty("maxLimit")
        ? overrides.maxLimit!
        : 8470,
    minLimit:
      overrides && overrides.hasOwnProperty("minLimit")
        ? overrides.minLimit!
        : 6055,
    name:
    ...
    options:
      overrides && overrides.hasOwnProperty("options")
        ? overrides.options!
        : [aCartAvailableBookableItemOption()]
  };
};

export const aCartAvailableBookableItemStaffVariant = (
  overrides?: Partial<CartAvailableBookableItemStaffVariant>
  ...
  return {
    ...
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "ad723bea-e9f9-479f-b39c-682a5215c446",
    price:
      overrides && overrides.hasOwnProperty("price")
        ? overrides.price!
        : "dicta",
...
export const aCartAvailableCategory = (
  overrides?: Partial<CartAvailableCategory>
): CartAvailableCategory => {
  return {
    availableItems:
      overrides && overrides.hasOwnProperty("availableItems")
        ? overrides.availableItems!
        : [aCartAvailableItem()],
    description:
      overrides && overrides.hasOwnProperty("description")
        ? overrides.description!
    ...
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "8a2c88f9-f92c-418d-8841-ed90383d6e7b",
    name:
      overrides && overrides.hasOwnProperty("name") ? overrides.name! : "minima"
  };
};

export const aCartAvailableGiftCardItem = (
  overrides?: Partial<CartAvailableGiftCardItem>
): CartAvailableGiftCardItem => {
  return {
    allowCustomAmounts:
      overrides && overrides.hasOwnProperty("allowCustomAmounts")
        ? overrides.allowCustomAmounts!
        : true,
    description:
      overrides && overrides.hasOwnProperty("description")
        ? overrides.description!
    ...
    disabledDescription:
      overrides && overrides.hasOwnProperty("disabledDescription")
        ...
        : "et",
    giftCardMax:
      overrides && overrides.hasOwnProperty("giftCardMax")
        ? overrides.giftCardMax!
        : "numquam",
    giftCardMin:
      overrides && overrides.hasOwnProperty("giftCardMin")
        ? overrides.giftCardMin!
        : "laborum",
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "5fac2110-f408-4b35-8bb5-0e064f22863f",
    listPrice:
      overrides && overrides.hasOwnProperty("listPrice")
        ? overrides.listPrice!
        : "qui",
    ...
    name:
      overrides && overrides.hasOwnProperty("name")
        ...
        : "explicabo",
    pricePresets:
      overrides && overrides.hasOwnProperty("pricePresets")
        ? overrides.pricePresets!
        : ["animi"]
  };
};

export const aCartAvailableItem = (
  overrides?: Partial<CartAvailableItem>
): CartAvailableItem => {
  return {
    description:
      overrides && overrides.hasOwnProperty("description")
    ...
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "6ff19028-4742-4516-b396-5789d977ca86",
    listPrice:
      overrides && overrides.hasOwnProperty("listPrice")
        ? overrides.listPrice!
        : "sint",
...
export const aCartAvailablePurchasableItem = (
  overrides?: Partial<CartAvailablePurchasableItem>
  ...
  return {
    ...
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "fb3e5138-2a5b-4eb3-94ba-7dcc04649423",
    listPrice:
      overrides && overrides.hasOwnProperty("listPrice")
        ? overrides.listPrice!
        : "est",
...
export const aCartBookableDate = (
  overrides?: Partial<CartBookableDate>
): CartBookableDate => {
  return {
    date:
      overrides && overrides.hasOwnProperty("date")
...
export const aCartBookableItem = (
  overrides?: Partial<CartBookableItem>
): CartBookableItem => {
  return {
    addons:
      overrides && overrides.hasOwnProperty("addons")
        ? overrides.addons!
        : [aCartAvailableItem()],
    availablePaymentMethods:
      overrides && overrides.hasOwnProperty("availablePaymentMethods")
        ...
        : [aCartItemPaymentMethod()],
    baseBookableItem:
      overrides && overrides.hasOwnProperty("baseBookableItem")
        ? overrides.baseBookableItem!
        : aBaseBookableItem(),
    discountAmount:
      overrides && overrides.hasOwnProperty("discountAmount")
        ? overrides.discountAmount!
        : "nulla",
    discountCode:
      overrides && overrides.hasOwnProperty("discountCode")
    ...
    errors:
      overrides && overrides.hasOwnProperty("errors")
        ...
        : [aCartItemError()],
    guest:
      overrides && overrides.hasOwnProperty("guest")
        ? overrides.guest!
        : aCartGuest(),
    guestId:
      overrides && overrides.hasOwnProperty("guestId")
        ? overrides.guestId!
        : "0d728340-acb2-4e08-922f-85bf1f47343a",
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "e9658e65-ef71-4cd0-88bf-9f693da66f61",
    item:
      overrides && overrides.hasOwnProperty("item")
        ? overrides.item!
        : aCartAvailableBookableItem(),
    lineTotal:
      overrides && overrides.hasOwnProperty("lineTotal")
        ? overrides.lineTotal!
        : "suscipit",
    price:
      overrides && overrides.hasOwnProperty("price")
    ...
    selectedPaymentMethod:
      overrides && overrides.hasOwnProperty("selectedPaymentMethod")
        ? overrides.selectedPaymentMethod!
        : aCartItemPaymentMethod(),
    selectedStaffVariant:
      overrides && overrides.hasOwnProperty("selectedStaffVariant")
        ? overrides.selectedStaffVariant!
        : aCartAvailableBookableItemStaffVariant(),
    startTime:
      overrides && overrides.hasOwnProperty("startTime")
        ? overrides.startTime!
        : "animi",
    taxAmount:
      overrides && overrides.hasOwnProperty("taxAmount")
        ? overrides.taxAmount!
        : "aliquam"
  };
};

export const aCartBookableTime = (
  overrides?: Partial<CartBookableTime>
): CartBookableTime => {
  return {
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "fbe82808-aa98-4c7f-b7e1-3d123d4f7b2a",
    score:
      overrides && overrides.hasOwnProperty("score") ? overrides.score! : 6.24,
    startTime:
      overrides && overrides.hasOwnProperty("startTime")
        ? overrides.startTime!
        : "ut"
...
export const aCartBookingQuestion = (
  overrides?: Partial<CartBookingQuestion>
): CartBookingQuestion => {
  return {
    answer:
      overrides && overrides.hasOwnProperty("answer")
        ? overrides.answer!
        : aCartBookingQuestionBooleanAnswer(),
    displayType:
    ...
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "82d3901e-c9f8-42fb-a054-0da101143cd9",
    ...
    options:
      overrides && overrides.hasOwnProperty("options")
        ? overrides.options!
        : [aCartBookingQuestionOption()],
    required:
      overrides && overrides.hasOwnProperty("required")
        ? overrides.required!
        : false,
    schema:
      overrides && overrides.hasOwnProperty("schema")
        ? overrides.schema!
        : CartBookingQuestionSchema.Appointment,
    valueType:
      overrides && overrides.hasOwnProperty("valueType")
        ? overrides.valueType!
        : CartBookingQuestionValueType.Boolean
  };
};

export const aCartBookingQuestionAddAnswerInput = (
  overrides?: Partial<CartBookingQuestionAddAnswerInput>
): CartBookingQuestionAddAnswerInput => {
  return {
    answer:
      overrides && overrides.hasOwnProperty("answer")
        ? overrides.answer!
        : aCartBookingQuestionAnswerInput(),
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "ee6ef44e-87a8-4e77-805f-07895920f80f",
    questionId:
      overrides && overrides.hasOwnProperty("questionId")
        ? overrides.questionId!
        : "36c7a0ad-eb38-4af5-9a90-c8a0fe9810e4"
  };
};

export const aCartBookingQuestionAddAnswerPayload = (
  overrides?: Partial<CartBookingQuestionAddAnswerPayload>
...
export const aCartBookingQuestionAnswerInput = (
  overrides?: Partial<CartBookingQuestionAnswerInput>
): CartBookingQuestionAnswerInput => {
  return {
    booleanValue:
      overrides && overrides.hasOwnProperty("booleanValue")
        ? overrides.booleanValue!
        : false,
    datetimeValue:
      overrides && overrides.hasOwnProperty("datetimeValue")
        ? overrides.datetimeValue!
        : "unde",
    floatValue:
      overrides && overrides.hasOwnProperty("floatValue")
        ? overrides.floatValue!
        : 3.91,
    integerValue:
      overrides && overrides.hasOwnProperty("integerValue")
        ? overrides.integerValue!
        : 3002,
    optionValue:
      overrides && overrides.hasOwnProperty("optionValue")
        ? overrides.optionValue!
        : aBookingQuestionOptionAnswerInput(),
    optionValues:
      overrides && overrides.hasOwnProperty("optionValues")
        ? overrides.optionValues!
        : [aBookingQuestionOptionAnswerInput()],
    textValue:
      overrides && overrides.hasOwnProperty("textValue")
        ? overrides.textValue!
        : "nulla"
  };
};

export const aCartBookingQuestionBooleanAnswer = (
  overrides?: Partial<CartBookingQuestionBooleanAnswer>
): CartBookingQuestionBooleanAnswer => {
  return {
    booleanValue:
      overrides && overrides.hasOwnProperty("booleanValue")
...
export const aCartBookingQuestionClearAnswerInput = (
  overrides?: Partial<CartBookingQuestionClearAnswerInput>
): CartBookingQuestionClearAnswerInput => {
  return {
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "9e678885-374f-40e6-ac6a-96c027ab5480",
    questionId:
      overrides && overrides.hasOwnProperty("questionId")
        ? overrides.questionId!
        : "617b57a1-9351-4580-bcb1-7b66589f1e3f"
  };
};

export const aCartBookingQuestionClearAnswerPayload = (
  overrides?: Partial<CartBookingQuestionClearAnswerPayload>
...
export const aCartBookingQuestionDatetimeAnswer = (
  overrides?: Partial<CartBookingQuestionDatetimeAnswer>
): CartBookingQuestionDatetimeAnswer => {
  return {
    datetimeValue:
      overrides && overrides.hasOwnProperty("datetimeValue")
...
export const aCartBookingQuestionFloatAnswer = (
  overrides?: Partial<CartBookingQuestionFloatAnswer>
): CartBookingQuestionFloatAnswer => {
  return {
    floatValue:
      overrides && overrides.hasOwnProperty("floatValue")
...
export const aCartBookingQuestionIntegerAnswer = (
  overrides?: Partial<CartBookingQuestionIntegerAnswer>
): CartBookingQuestionIntegerAnswer => {
  return {
    integerValue:
      overrides && overrides.hasOwnProperty("integerValue")
...
export const aCartBookingQuestionMultiSelectAnswer = (
  overrides?: Partial<CartBookingQuestionMultiSelectAnswer>
): CartBookingQuestionMultiSelectAnswer => {
  return {
    options:
      overrides && overrides.hasOwnProperty("options")
...
export const aCartBookingQuestionOption = (
  overrides?: Partial<CartBookingQuestionOption>
): CartBookingQuestionOption => {
  return {
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "cd9f7dc2-16cd-4a30-815a-b7b2c9ed7d48",
    label:
      overrides && overrides.hasOwnProperty("label") ? overrides.label! : "eius"
  };
};

export const aCartBookingQuestionSelectAnswer = (
  overrides?: Partial<CartBookingQuestionSelectAnswer>
): CartBookingQuestionSelectAnswer => {
  return {
    option:
      overrides && overrides.hasOwnProperty("option")
        ? overrides.option!
        : aCartBookingQuestionOption()
  };
};

export const aCartBookingQuestionTextAnswer = (
  overrides?: Partial<CartBookingQuestionTextAnswer>
): CartBookingQuestionTextAnswer => {
  return {
    textValue:
      overrides && overrides.hasOwnProperty("textValue")
...
export const aCartClearInput = (
  overrides?: Partial<CartClearInput>
): CartClearInput => {
  return {
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "6a3a071e-ac4a-402d-bc3e-172db90282c2"
  };
};

export const aCartClearPayload = (
  overrides?: Partial<CartClearPayload>
): CartClearPayload => {
  return {
    cart:
      overrides && overrides.hasOwnProperty("cart") ? overrides.cart! : aCart()
...
export const aCartClientInformation = (
  overrides?: Partial<CartClientInformation>
...
export const aCartClientInformationInput = (
  overrides?: Partial<CartClientInformationInput>
...
export const aCartDurationRange = (
  overrides?: Partial<CartDurationRange>
): CartDurationRange => {
  return {
    ...
    variable:
      overrides && overrides.hasOwnProperty("variable")
        ? overrides.variable!
        : false
  };
};
  ...
  return {
    code:
      overrides && overrides.hasOwnProperty("code")
        ? overrides.code!
        : CartErrorCode.CartBookingQuestionAnswerMissing,
    description:
      overrides && overrides.hasOwnProperty("description")
        ? overrides.description!
        : "omnis",
...
export const aCartFeatures = (
  overrides?: Partial<CartFeatures>
): CartFeatures => {
  return {
    bookingQuestionsEnabled:
      overrides && overrides.hasOwnProperty("bookingQuestionsEnabled")
        ? overrides.bookingQuestionsEnabled!
        : true,
    giftCardPurchaseEnabled:
      overrides && overrides.hasOwnProperty("giftCardPurchaseEnabled")
        ? overrides.giftCardPurchaseEnabled!
        : true,
    paymentInfoRequired:
      overrides && overrides.hasOwnProperty("paymentInfoRequired")
        ? overrides.paymentInfoRequired!
        : false,
    serviceAddonsEnabled:
      overrides && overrides.hasOwnProperty("serviceAddonsEnabled")
        ? overrides.serviceAddonsEnabled!
        : false
  };
};

export const aCartGiftCardItem = (
  overrides?: Partial<CartGiftCardItem>
): CartGiftCardItem => {
  return {
    addons:
      overrides && overrides.hasOwnProperty("addons")
    ...
    discountCode:
      overrides && overrides.hasOwnProperty("discountCode")
        ...
        : "nemo",
    emailFulfillment:
      overrides && overrides.hasOwnProperty("emailFulfillment")
        ? overrides.emailFulfillment!
        : aCartItemEmailFulfillment(),
    errors:
      overrides && overrides.hasOwnProperty("errors")
        ? overrides.errors!
        : [aCartItemError()],
    giftCardDesign:
      overrides && overrides.hasOwnProperty("giftCardDesign")
        ? overrides.giftCardDesign!
        : aCartItemGiftCardDesign(),
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "fd6c0653-c6b9-46b5-8261-f041c0e65446",
    item:
      overrides && overrides.hasOwnProperty("item")
        ? overrides.item!
        : aCartAvailableGiftCardItem(),
    lineTotal:
      overrides && overrides.hasOwnProperty("lineTotal")
        ? overrides.lineTotal!
        : "et",
...
export const aCartGuest = (overrides?: Partial<CartGuest>): CartGuest => {
  return {
    ...
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "e99ad070-8cef-41ce-b0d5-9829b8cf9a84",
    label:
      overrides && overrides.hasOwnProperty("label")
        ? overrides.label!
        : "atque",
...
export const aCartItemCardPaymentMethod = (
  overrides?: Partial<CartItemCardPaymentMethod>
): CartItemCardPaymentMethod => {
  return {
    cardBrand:
      overrides && overrides.hasOwnProperty("cardBrand")
        ? overrides.cardBrand!
        : "voluptas",
    cardExpMonth:
      overrides && overrides.hasOwnProperty("cardExpMonth")
        ? overrides.cardExpMonth!
        : 9251,
    cardExpYear:
      overrides && overrides.hasOwnProperty("cardExpYear")
        ? overrides.cardExpYear!
        : 1037,
    cardHolder:
      overrides && overrides.hasOwnProperty("cardHolder")
        ? overrides.cardHolder!
        : "quos",
    cardIsDefault:
      overrides && overrides.hasOwnProperty("cardIsDefault")
        ? overrides.cardIsDefault!
        : false,
    cardLast4:
      overrides && overrides.hasOwnProperty("cardLast4")
        ? overrides.cardLast4!
        : "corrupti",
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "012384a6-5e8b-4116-8656-60f062983a79",
    name:
      overrides && overrides.hasOwnProperty("name") ? overrides.name! : "fugit"
  };
};

export const aCartItemEmailFulfillment = (
  overrides?: Partial<CartItemEmailFulfillment>
): CartItemEmailFulfillment => {
  return {
    deliveryDate:
      overrides && overrides.hasOwnProperty("deliveryDate")
        ? overrides.deliveryDate!
        : "1991-05-14",
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "485d1fc1-e2eb-4708-a3b5-db85cb8c61ff",
    messageFromSender:
      overrides && overrides.hasOwnProperty("messageFromSender")
        ? overrides.messageFromSender!
        : "perspiciatis",
    recipientEmail:
      overrides && overrides.hasOwnProperty("recipientEmail")
        ? overrides.recipientEmail!
        : "vel",
    recipientName:
      overrides && overrides.hasOwnProperty("recipientName")
        ? overrides.recipientName!
        : "quis",
    senderName:
      overrides && overrides.hasOwnProperty("senderName")
        ? overrides.senderName!
        : "totam"
  };
};

export const aCartItemError = (
  overrides?: Partial<CartItemError>
): CartItemError => {
  return {
    code:
      overrides && overrides.hasOwnProperty("code")
        ? overrides.code!
        : CartItemErrorCode.CartMissingItemPaymentMethod,
    description:
      overrides && overrides.hasOwnProperty("description")
        ? overrides.description!
        : "veritatis",
...
export const aCartItemGiftCardDesign = (
  overrides?: Partial<CartItemGiftCardDesign>
  ...
  return {
    backgroundColor:
      overrides && overrides.hasOwnProperty("backgroundColor")
        ...
        : "ut",
    foregroundText:
      overrides && overrides.hasOwnProperty("foregroundText")
        ? overrides.foregroundText!
        : "aut",
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "c3487924-d5ed-42ef-858f-2dd3d200719a",
    image:
      overrides && overrides.hasOwnProperty("image") ? overrides.image! : "cum"
  };
};

export const aCartItemPaymentMethod = (
  overrides?: Partial<CartItemPaymentMethod>
): CartItemPaymentMethod => {
  return {
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "ad35f645-97e1-48cf-9e6c-3770fa05c9ed",
    name: overrides && overrides.hasOwnProperty("name") ? overrides.name! : "ut"
  };
};

export const aCartItemVoucherPaymentMethod = (
  overrides?: Partial<CartItemVoucherPaymentMethod>
): CartItemVoucherPaymentMethod => {
  return {
    availableCount:
      overrides && overrides.hasOwnProperty("availableCount")
        ? overrides.availableCount!
        : 9164,
    availableVoucherIds:
      overrides && overrides.hasOwnProperty("availableVoucherIds")
        ? overrides.availableVoucherIds!
        : ["a237ac53-0dfd-4134-9796-b552f9d54002"],
    expiresOn:
    ...
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "0db55573-7ecd-4d87-9b88-5ac430da015a",
    name:
...
export const aCartOffer = (overrides?: Partial<CartOffer>): CartOffer => {
  return {
    applied:
      overrides && overrides.hasOwnProperty("applied")
        ? overrides.applied!
        : false,
    code:
      overrides && overrides.hasOwnProperty("code") ? overrides.code! : "qui",
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "4981842e-0768-4e79-8f14-b58322dc971a",
    name:
      overrides && overrides.hasOwnProperty("name")
        ? overrides.name!
        : "temporibus"
...
export const aCartPriceRange = (
  overrides?: Partial<CartPriceRange>
): CartPriceRange => {
  return {
...
export const aCartPurchasableItem = (
  overrides?: Partial<CartPurchasableItem>
): CartPurchasableItem => {
  return {
    addons:
      overrides && overrides.hasOwnProperty("addons")
    ...
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "3df93967-ad48-408f-b92e-a66c42d471a6",
    item:
      overrides && overrides.hasOwnProperty("item")
        ? overrides.item!
        : aCartAvailablePurchasableItem(),
    lineTotal:
      overrides && overrides.hasOwnProperty("lineTotal")
        ? overrides.lineTotal!
        : "eum",
...
export const aCartSetLocationInput = (
  overrides?: Partial<CartSetLocationInput>
): CartSetLocationInput => {
  return {
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "5e4ba3c6-d1e6-463e-89e3-72781101dcbc",
    locationId:
      overrides && overrides.hasOwnProperty("locationId")
        ? overrides.locationId!
        : "a8157f74-51ab-4e9a-bff5-2a8fcab7513c"
  };
};

export const aCartSetLocationPayload = (
  overrides?: Partial<CartSetLocationPayload>
  ...
  return {
    deposit:
      overrides && overrides.hasOwnProperty("deposit")
        ? overrides.deposit!
        : DepositType.FullDeposit,
    depositAmount:
      overrides && overrides.hasOwnProperty("depositAmount")
    ...
    discountAmount:
      overrides && overrides.hasOwnProperty("discountAmount")
        ...
        : "sed",
    gratuityAmount:
      overrides && overrides.hasOwnProperty("gratuityAmount")
        ? overrides.gratuityAmount!
        : "quia",
    paymentMethodRequired:
      overrides && overrides.hasOwnProperty("paymentMethodRequired")
        ? overrides.paymentMethodRequired!
        : false,
    roundingAmount:
      overrides && overrides.hasOwnProperty("roundingAmount")
        ? overrides.roundingAmount!
        : "et",
    subtotal:
      overrides && overrides.hasOwnProperty("subtotal")
        ? overrides.subtotal!
        : "quis",
    taxAmount:
      overrides && overrides.hasOwnProperty("taxAmount")
...
export const aCheckoutCartInput = (
  ...
  return {
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "6e9ccdf8-a952-454c-817e-c88cdfc53f80"
  };
};

export const aCheckoutCartPayload = (
  overrides?: Partial<CheckoutCartPayload>
): CheckoutCartPayload => {
  return {
    appointments:
      overrides && overrides.hasOwnProperty("appointments")
...
export const aClient = (overrides?: Partial<Client>): Client => {
  return {
    communicationSubscriptions:
      overrides && overrides.hasOwnProperty("communicationSubscriptions")
        ? overrides.communicationSubscriptions!
        : [aCommunicationSubscription()],
    email:
      overrides && overrides.hasOwnProperty("email")
        ? overrides.email!
        : "molestias",
    ...
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "c884717e-580f-4651-a68e-705d18cd7f0e",
    insertedAt:
      overrides && overrides.hasOwnProperty("insertedAt")
        ? overrides.insertedAt!
        : "officia",
    lastName:
      overrides && overrides.hasOwnProperty("lastName")
        ...
        : "perspiciatis",
    mobilePhone:
      overrides && overrides.hasOwnProperty("mobilePhone")
...
export const aClientNote = (overrides?: Partial<ClientNote>): ClientNote => {
  return {
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "d45fa612-40b6-40fd-ab8f-40576cc7ede1",
    insertedAt:
      overrides && overrides.hasOwnProperty("insertedAt")
        ? overrides.insertedAt!
        : "natus",
...
export const aCommunicationChannelPreference = (
  overrides?: Partial<CommunicationChannelPreference>
): CommunicationChannelPreference => {
  return {
    communicationChannel:
      overrides && overrides.hasOwnProperty("communicationChannel")
        ? overrides.communicationChannel!
        : CommunicationChannel.Email,
    enabled:
      overrides && overrides.hasOwnProperty("enabled")
        ? overrides.enabled!
        : true
  };
};

export const aCommunicationSubscription = (
  overrides?: Partial<CommunicationSubscription>
): CommunicationSubscription => {
  return {
    communicationChannelPreferences:
      overrides && overrides.hasOwnProperty("communicationChannelPreferences")
        ? overrides.communicationChannelPreferences!
        : [aCommunicationChannelPreference()],
    description:
      overrides && overrides.hasOwnProperty("description")
        ? overrides.description!
        : "dolorum",
    key:
      overrides && overrides.hasOwnProperty("key")
        ? overrides.key!
        : CommunicationKey.AppointmentReminder,
    title:
...
export const aCommunicationSubscriptionInput = (
  overrides?: Partial<CommunicationSubscriptionInput>
): CommunicationSubscriptionInput => {
  return {
    channel:
      overrides && overrides.hasOwnProperty("channel")
        ? overrides.channel!
        : CommunicationChannel.Email,
    enabled:
      overrides && overrides.hasOwnProperty("enabled")
...
export const aConfirmAppointmentInput = (
  overrides?: Partial<ConfirmAppointmentInput>
): ConfirmAppointmentInput => {
  return {
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "384c3c41-c7aa-424b-8a45-6fa9a8d6923f"
  };
};

export const aConfirmAppointmentPayload = (
  overrides?: Partial<ConfirmAppointmentPayload>
...
export const aCreateCartGiftCardItemEmailFulfillmentInput = (
  overrides?: Partial<CreateCartGiftCardItemEmailFulfillmentInput>
  ...
  return {
    ...
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "a42f1a85-0f55-48a7-95cd-918a7d0ce82e",
    itemId:
      overrides && overrides.hasOwnProperty("itemId")
        ? overrides.itemId!
        : "6df8c5a0-66ae-472d-95d3-fd5dee41d9e6",
    messageFromSender:
      overrides && overrides.hasOwnProperty("messageFromSender")
        ? overrides.messageFromSender!
        : "molestiae",
...
export const aCreateCartGiftCardItemEmailFulfillmentPayload = (
  overrides?: Partial<CreateCartGiftCardItemEmailFulfillmentPayload>
...
export const aCreateCartGuestInput = (
  overrides?: Partial<CreateCartGuestInput>
  ...
  return {
    ...
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "7d2a124b-ca45-42ce-b3e8-59fbf3793f6c",
    lastName:
      overrides && overrides.hasOwnProperty("lastName")
        ? overrides.lastName!
        : "sapiente",
...
export const aCreateCartGuestPayload = (
  overrides?: Partial<CreateCartGuestPayload>
...
export const aCreateCartInput = (
  ...
  return {
    advanceGratuity:
      overrides && overrides.hasOwnProperty("advanceGratuity")
        ? overrides.advanceGratuity!
        : aCartAdvanceGratuityInput(),
    clientInformation:
      overrides && overrides.hasOwnProperty("clientInformation")
        ? overrides.clientInformation!
        : aCartClientInformationInput(),
    clientMessage:
      overrides && overrides.hasOwnProperty("clientMessage")
        ? overrides.clientMessage!
        : "consequatur",
    ...
    locationId:
      overrides && overrides.hasOwnProperty("locationId")
        ? overrides.locationId!
        : "72d57caf-a053-423a-884f-644b8bbfec80",
    referralSource:
      overrides && overrides.hasOwnProperty("referralSource")
        ? overrides.referralSource!
        : "omnis"
  };
};

export const aCreateCartPayload = (
  overrides?: Partial<CreateCartPayload>
): CreateCartPayload => {
  return {
    cart:
      overrides && overrides.hasOwnProperty("cart") ? overrides.cart! : aCart()
...
export const aCreateClientNoteInput = (
  overrides?: Partial<CreateClientNoteInput>
): CreateClientNoteInput => {
  return {
    text:
      overrides && overrides.hasOwnProperty("text") ? overrides.text! : "ut",
    type:
      overrides && overrides.hasOwnProperty("type")
        ? overrides.type!
        : NoteType.Allergy
...
export const aCreateClientNotePayload = (
  overrides?: Partial<CreateClientNotePayload>
): CreateClientNotePayload => {
  return {
    clientNote:
      overrides && overrides.hasOwnProperty("clientNote")
        ? overrides.clientNote!
        : aClientNote()
  };
};

export const aCreateCreditCardInput = (
  ...
  return {
    nickname:
      overrides && overrides.hasOwnProperty("nickname")
        ...
        : "saepe",
    vaultToken:
      overrides && overrides.hasOwnProperty("vaultToken")
        ? overrides.vaultToken!
        : "enim"
  };
};

export const aCreateCreditCardResult = (
  overrides?: Partial<CreateCreditCardResult>
...
export const aCreateCustomFormInput = (
  overrides?: Partial<CreateCustomFormInput>
): CreateCustomFormInput => {
  return {
    answers:
      overrides && overrides.hasOwnProperty("answers")
        ? overrides.answers!
        : [aCustomFormAnswer()],
    appointmentId:
      overrides && overrides.hasOwnProperty("appointmentId")
        ? overrides.appointmentId!
        : "ce074b34-4542-479e-a282-9349074546b7",
    offline:
      overrides && overrides.hasOwnProperty("offline")
        ? overrides.offline!
        : false,
    submit:
      overrides && overrides.hasOwnProperty("submit")
        ...
        : false,
    submittedAt:
      overrides && overrides.hasOwnProperty("submittedAt")
        ? overrides.submittedAt!
        : "voluptatibus",
    versionId:
      overrides && overrides.hasOwnProperty("versionId")
        ? overrides.versionId!
        : "2f93a17f-e77c-45cd-8bee-83c8de19ebb0"
  };
};
...
export const aCreditCard = (overrides?: Partial<CreditCard>): CreditCard => {
  return {
    brand:
      overrides && overrides.hasOwnProperty("brand")
        ? overrides.brand!
        : CardBrand.Amex,
    expMonth:
      overrides && overrides.hasOwnProperty("expMonth")
        ? overrides.expMonth!
        : 4649,
    expYear:
      overrides && overrides.hasOwnProperty("expYear")
        ? overrides.expYear!
        : 6696,
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "a760a67f-55cf-493e-b870-36139c4bfbf6",
    isExpired:
      overrides && overrides.hasOwnProperty("isExpired")
        ? overrides.isExpired!
        : false,
    last4:
      overrides && overrides.hasOwnProperty("last4") ? overrides.last4! : "illo"
  };
};

export const aCreditCardConnection = (
  overrides?: Partial<CreditCardConnection>
...
export const aCreditCardEdge = (
  overrides?: Partial<CreditCardEdge>
): CreditCardEdge => {
  return {
    cursor:
      overrides && overrides.hasOwnProperty("cursor")
...
export const aCustomForm = (overrides?: Partial<CustomForm>): CustomForm => {
  return {
    appointmentId:
      overrides && overrides.hasOwnProperty("appointmentId")
        ? overrides.appointmentId!
        : "c470891b-6dd5-4d45-a480-a1d455776ab0",
    clientId:
      overrides && overrides.hasOwnProperty("clientId")
        ? overrides.clientId!
        : "76f2e697-7dc2-4cde-aa1f-2c7d9f144b2a",
    components:
      overrides && overrides.hasOwnProperty("components")
        ? overrides.components!
        : [aCustomFormComponent()],
    formTemplate:
      overrides && overrides.hasOwnProperty("formTemplate")
        ? overrides.formTemplate!
        : aFormTemplate(),
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "329cf99e-2a1f-45d1-9960-ebb1fd5d85f2",
    insertedAt:
      overrides && overrides.hasOwnProperty("insertedAt")
        ? overrides.insertedAt!
        : "accusantium",
    notStarted:
      overrides && overrides.hasOwnProperty("notStarted")
        ? overrides.notStarted!
        : false,
    submittedAt:
      overrides && overrides.hasOwnProperty("submittedAt")
        ? overrides.submittedAt!
...
export const aCustomFormAnswer = (
  overrides?: Partial<CustomFormAnswer>
): CustomFormAnswer => {
  return {
    checkboxAnswer:
      overrides && overrides.hasOwnProperty("checkboxAnswer")
        ? overrides.checkboxAnswer!
        : ["04c3d97d-8cb0-4f2e-8424-c324878f2dbb"],
    dateAnswer:
      overrides && overrides.hasOwnProperty("dateAnswer")
        ? overrides.dateAnswer!
        : "et",
    dropdownAnswer:
      overrides && overrides.hasOwnProperty("dropdownAnswer")
        ? overrides.dropdownAnswer!
        : ["a8e1a8af-24e7-448f-bf9f-17fb4bfa252b"],
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "5bf42edc-2ab3-4d31-bf46-cb693c8f157f",
    imageAnswer:
      overrides && overrides.hasOwnProperty("imageAnswer")
        ? overrides.imageAnswer!
        : aCustomFormImageAnswer(),
    otherAnswer:
      overrides && overrides.hasOwnProperty("otherAnswer")
        ? overrides.otherAnswer!
        : "quia",
    radioAnswer:
      overrides && overrides.hasOwnProperty("radioAnswer")
        ? overrides.radioAnswer!
        : "02781678-1b8b-446b-aae2-0eee94cb948e",
    selectAnswer:
      overrides && overrides.hasOwnProperty("selectAnswer")
        ? overrides.selectAnswer!
        : ["002623a1-6adc-48f5-8c93-88cced4228ac"],
    signatureAnswer:
      overrides && overrides.hasOwnProperty("signatureAnswer")
        ? overrides.signatureAnswer!
        : aCustomFormSignatureAnswer(),
    textAnswer:
      overrides && overrides.hasOwnProperty("textAnswer")
        ? overrides.textAnswer!
        : "voluptates",
    textareaAnswer:
      overrides && overrides.hasOwnProperty("textareaAnswer")
        ? overrides.textareaAnswer!
        : "reprehenderit"
  };
};

export const aCustomFormComponent = (
  overrides?: Partial<CustomFormComponent>
): CustomFormComponent => {
  return {
    ...
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "03f34f15-43b6-403d-9c52-e87be5c45a12",
    kind:
      overrides && overrides.hasOwnProperty("kind")
        ? overrides.kind!
        : FormComponentKind.Checkbox,
...
export const aCustomFormComponentCheckbox = (
  overrides?: Partial<CustomFormComponentCheckbox>
): CustomFormComponentCheckbox => {
  return {
    checkboxAnswer:
      overrides && overrides.hasOwnProperty("checkboxAnswer")
        ? overrides.checkboxAnswer!
        : ["6e144661-e646-4ca9-8480-bf3371cb3907"],
    floatWidth:
      overrides && overrides.hasOwnProperty("floatWidth")
    ...
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "65d8e03c-acd0-44b2-ba9a-d3d57c1f17a0",
    kind:
      overrides && overrides.hasOwnProperty("kind")
        ? overrides.kind!
        : FormComponentKind.Checkbox,
    label:
      overrides && overrides.hasOwnProperty("label") ? overrides.label! : "quo",
    required:
      overrides && overrides.hasOwnProperty("required")
        ? overrides.required!
        : true,
...
export const aCustomFormComponentCheckboxV2 = (
  overrides?: Partial<CustomFormComponentCheckboxV2>
): CustomFormComponentCheckboxV2 => {
  return {
    checkboxAnswer:
      overrides && overrides.hasOwnProperty("checkboxAnswer")
        ? overrides.checkboxAnswer!
        : ["168e03b2-6e1e-4c2a-a40a-3b9654fab969"],
    enableOther:
      overrides && overrides.hasOwnProperty("enableOther")
        ? overrides.enableOther!
        : false,
    h: overrides && overrides.hasOwnProperty("h") ? overrides.h! : 9752,
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "efda677f-01cd-4fc1-94eb-13a56a742aa8",
    kind:
      overrides && overrides.hasOwnProperty("kind")
        ? overrides.kind!
        : FormComponentKind.Checkbox,
...
export const aCustomFormComponentDate = (
  overrides?: Partial<CustomFormComponentDate>
  ...
  return {
    ...
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "8e304ba9-55b4-41f4-8006-d617ef8832fc",
    kind:
      overrides && overrides.hasOwnProperty("kind")
        ? overrides.kind!
        : FormComponentKind.Checkbox,
...
export const aCustomFormComponentDateV2 = (
  overrides?: Partial<CustomFormComponentDateV2>
): CustomFormComponentDateV2 => {
  return {
    autoPopulate:
      overrides && overrides.hasOwnProperty("autoPopulate")
        ? overrides.autoPopulate!
        : false,
    connectedField:
      overrides && overrides.hasOwnProperty("connectedField")
        ? overrides.connectedField!
        : "dolor",
    connectedSource:
      overrides && overrides.hasOwnProperty("connectedSource")
        ? overrides.connectedSource!
        : "cum",
    dateAnswer:
      overrides && overrides.hasOwnProperty("dateAnswer")
        ? overrides.dateAnswer!
    ...
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "58c6819e-e4a9-434d-8878-cb394bc65fbb",
    kind:
      overrides && overrides.hasOwnProperty("kind")
        ? overrides.kind!
        : FormComponentKind.Checkbox,
...
export const aCustomFormComponentDividerV2 = (
  overrides?: Partial<CustomFormComponentDividerV2>
  ...
  return {
    ...
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "4b5cd4ca-3e21-4ff3-b3c6-b9f8053372d3",
    kind:
      overrides && overrides.hasOwnProperty("kind")
        ? overrides.kind!
        : FormComponentKind.Checkbox,
...
export const aCustomFormComponentDropdownV2 = (
  overrides?: Partial<CustomFormComponentDropdownV2>
  ...
  return {
    ...
    dropdownAnswer:
      overrides && overrides.hasOwnProperty("dropdownAnswer")
        ? overrides.dropdownAnswer!
        : ["848214cf-2921-4c9a-b043-6e986edc93fb"],
    h: overrides && overrides.hasOwnProperty("h") ? overrides.h! : 5751,
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "9fc56df1-bbae-41f6-b28f-c1dcd64b2518",
    kind:
      overrides && overrides.hasOwnProperty("kind")
        ? overrides.kind!
        : FormComponentKind.Checkbox,
    ...
    manageReferralSourcesByLocation:
      overrides && overrides.hasOwnProperty("manageReferralSourcesByLocation")
        ...
        : false,
    multiple:
      overrides && overrides.hasOwnProperty("multiple")
        ? overrides.multiple!
        : true,
    required:
      overrides && overrides.hasOwnProperty("required")
...
export const aCustomFormComponentH1 = (
  overrides?: Partial<CustomFormComponentH1>
  ...
  return {
    ...
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "e922b85f-0cd6-47d2-8295-e65628360413",
    kind:
      overrides && overrides.hasOwnProperty("kind")
        ? overrides.kind!
        : FormComponentKind.Checkbox,
...
export const aCustomFormComponentH2 = (
  overrides?: Partial<CustomFormComponentH2>
  ...
  return {
    ...
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "6fbebef8-9306-4bfd-b380-03f79f879b00",
    kind:
      overrides && overrides.hasOwnProperty("kind")
        ? overrides.kind!
        : FormComponentKind.Checkbox,
...
export const aCustomFormComponentImageAnswer = (
  overrides?: Partial<CustomFormComponentImageAnswer>
): CustomFormComponentImageAnswer => {
  return {
    annotatedImageUrl:
      overrides && overrides.hasOwnProperty("annotatedImageUrl")
        ? overrides.annotatedImageUrl!
        : "unde",
    canvasDataUrl:
      overrides && overrides.hasOwnProperty("canvasDataUrl")
        ? overrides.canvasDataUrl!
        : "adipisci",
    customFormImageId:
      overrides && overrides.hasOwnProperty("customFormImageId")
        ? overrides.customFormImageId!
        : "5aff1281-8e69-4f6d-b704-198069e86ee4",
    sourceImageUrl:
      overrides && overrides.hasOwnProperty("sourceImageUrl")
        ? overrides.sourceImageUrl!
        : "sint"
  };
};

export const aCustomFormComponentImageUploaderV2 = (
  overrides?: Partial<CustomFormComponentImageUploaderV2>
): CustomFormComponentImageUploaderV2 => {
  return {
    enableImageMarkup:
      overrides && overrides.hasOwnProperty("enableImageMarkup")
        ? overrides.enableImageMarkup!
        : false,
    fileUpload:
      overrides && overrides.hasOwnProperty("fileUpload")
        ? overrides.fileUpload!
        : aCustomFormComponentSignatureUpload(),
    h: overrides && overrides.hasOwnProperty("h") ? overrides.h! : 3519,
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "4c392cba-46bf-4894-b9ee-fe123d13cc57",
    imageAnswer:
      overrides && overrides.hasOwnProperty("imageAnswer")
        ? overrides.imageAnswer!
        : aCustomFormComponentImageAnswer(),
    kind:
      overrides && overrides.hasOwnProperty("kind")
        ? overrides.kind!
        : FormComponentKind.Checkbox,
    label:
      overrides && overrides.hasOwnProperty("label") ? overrides.label! : "et",
    required:
      overrides && overrides.hasOwnProperty("required")
        ? overrides.required!
        : true,
...
export const aCustomFormComponentImageV2 = (
  overrides?: Partial<CustomFormComponentImageV2>
  ...
  return {
    enableImageMarkup:
      overrides && overrides.hasOwnProperty("enableImageMarkup")
        ...
        : false,
    fileUploadId:
      overrides && overrides.hasOwnProperty("fileUploadId")
        ? overrides.fileUploadId!
        : "tenetur",
    h: overrides && overrides.hasOwnProperty("h") ? overrides.h! : 6055,
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "47245256-45dd-4610-aac7-a6c2dffaba65",
    imageAnswer:
      overrides && overrides.hasOwnProperty("imageAnswer")
        ? overrides.imageAnswer!
        : aCustomFormComponentImageAnswer(),
    ...
    label:
      overrides && overrides.hasOwnProperty("label")
        ...
        : "dolorem",
    src:
      overrides && overrides.hasOwnProperty("src") ? overrides.src! : "quidem",
...
export const aCustomFormComponentLogo = (
  overrides?: Partial<CustomFormComponentLogo>
  ...
  return {
    ...
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "3191facc-5461-4b9f-84f9-9bc23dac2a39",
    kind:
      overrides && overrides.hasOwnProperty("kind")
        ? overrides.kind!
        : FormComponentKind.Checkbox,
    markdownContent:
      overrides && overrides.hasOwnProperty("markdownContent")
        ? overrides.markdownContent!
        : "ea",
    markdownHtml:
      overrides && overrides.hasOwnProperty("markdownHtml")
        ? overrides.markdownHtml!
        : "consequatur",
...
export const aCustomFormComponentLogoV2 = (
  overrides?: Partial<CustomFormComponentLogoV2>
  ...
  return {
    ...
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "87b4d798-0b7a-4816-8960-c6871c1a8b10",
    kind:
      overrides && overrides.hasOwnProperty("kind")
        ? overrides.kind!
        : FormComponentKind.Checkbox,
    src:
      overrides && overrides.hasOwnProperty("src")
        ? overrides.src!
        : "incidunt",
...
export const aCustomFormComponentMarkdown = (
  overrides?: Partial<CustomFormComponentMarkdown>
  ...
  return {
    ...
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "fcd0b3e9-7f91-4254-af7e-e3118b4aabcc",
    kind:
      overrides && overrides.hasOwnProperty("kind")
        ? overrides.kind!
        : FormComponentKind.Checkbox,
...
export const aCustomFormComponentMultipleChoiceV2 = (
  overrides?: Partial<CustomFormComponentMultipleChoiceV2>
  ...
  return {
    ...
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "cdc851f3-1af4-4c86-b8a8-b9fd87cd5a35",
    kind:
      overrides && overrides.hasOwnProperty("kind")
        ? overrides.kind!
        : FormComponentKind.Checkbox,
    label:
      overrides && overrides.hasOwnProperty("label") ? overrides.label! : "est",
    otherAnswer:
      overrides && overrides.hasOwnProperty("otherAnswer")
        ? overrides.otherAnswer!
        : "quibusdam",
...
export const aCustomFormComponentRadio = (
  overrides?: Partial<CustomFormComponentRadio>
  ...
  return {
    ...
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "9ec19d31-9bbb-4450-b1c6-da9b4fef0d24",
    kind:
      overrides && overrides.hasOwnProperty("kind")
        ? overrides.kind!
        : FormComponentKind.Checkbox,
    ...
    values:
      overrides && overrides.hasOwnProperty("values")
        ? overrides.values!
        : [aCustomFormComponentRadioValue()],
...
export const aCustomFormComponentRadioValue = (
  overrides?: Partial<CustomFormComponentRadioValue>
...
export const aCustomFormComponentSelect = (
  overrides?: Partial<CustomFormComponentSelect>
  ...
  return {
    ...
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "f5d0aa7f-288f-4947-9b00-87554be14a3e",
    kind:
      overrides && overrides.hasOwnProperty("kind")
        ? overrides.kind!
        : FormComponentKind.Checkbox,
    ...
    selectAnswer:
      overrides && overrides.hasOwnProperty("selectAnswer")
        ...
        : ["porro"],
    selectMultiple:
      overrides && overrides.hasOwnProperty("selectMultiple")
        ? overrides.selectMultiple!
        : true,
    values:
      overrides && overrides.hasOwnProperty("values")
        ? overrides.values!
        : [aCustomFormComponentSelectValue()],
...
export const aCustomFormComponentSelectValue = (
  overrides?: Partial<CustomFormComponentSelectValue>
...
export const aCustomFormComponentSignature = (
  overrides?: Partial<CustomFormComponentSignature>
): CustomFormComponentSignature => {
  return {
    enableWet:
      overrides && overrides.hasOwnProperty("enableWet")
        ? overrides.enableWet!
        : false,
    fileUpload:
      overrides && overrides.hasOwnProperty("fileUpload")
    ...
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "8b7f765d-a0ac-4069-af45-04dc447aadfc",
    kind:
      overrides && overrides.hasOwnProperty("kind")
        ? overrides.kind!
        : FormComponentKind.Checkbox,
    ...
    signatureAnswer:
      overrides && overrides.hasOwnProperty("signatureAnswer")
        ? overrides.signatureAnswer!
        : aCustomFormComponentSignatureAnswer(),
...
export const aCustomFormComponentSignatureAnswer = (
  overrides?: Partial<CustomFormComponentSignatureAnswer>
): CustomFormComponentSignatureAnswer => {
  return {
    fileUploadId:
      overrides && overrides.hasOwnProperty("fileUploadId")
        ? overrides.fileUploadId!
        : "75d7e9d9-2dbb-4efc-922d-12cc3bf98c29",
    name:
      overrides && overrides.hasOwnProperty("name")
        ? overrides.name!
        : "assumenda",
...
export const aCustomFormComponentSignatureUpload = (
  overrides?: Partial<CustomFormComponentSignatureUpload>
): CustomFormComponentSignatureUpload => {
  return {
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "9ef0b671-68a4-4fd3-8e96-529b47d9127a",
    signedPutUrl:
      overrides && overrides.hasOwnProperty("signedPutUrl")
        ? overrides.signedPutUrl!
        : "ut"
  };
};

export const aCustomFormComponentSignatureV2 = (
  overrides?: Partial<CustomFormComponentSignatureV2>
): CustomFormComponentSignatureV2 => {
  return {
    enableWetV2:
      overrides && overrides.hasOwnProperty("enableWetV2")
        ? overrides.enableWetV2!
        : true,
    fileUpload:
      overrides && overrides.hasOwnProperty("fileUpload")
        ? overrides.fileUpload!
    ...
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "8fefa92b-0ff0-4efe-9b92-0ef3add9a078",
    kind:
      overrides && overrides.hasOwnProperty("kind")
        ? overrides.kind!
        : FormComponentKind.Checkbox,
...
export const aCustomFormComponentText = (
  overrides?: Partial<CustomFormComponentText>
  ...
  return {
    ...
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "9b6989a5-dd91-4322-a852-68e5dc0e4c56",
    kind:
      overrides && overrides.hasOwnProperty("kind")
        ? overrides.kind!
        : FormComponentKind.Checkbox,
    label:
      overrides && overrides.hasOwnProperty("label")
        ...
        : "illo",
    placeholder:
      overrides && overrides.hasOwnProperty("placeholder")
...
export const aCustomFormComponentTextInputV2 = (
  overrides?: Partial<CustomFormComponentTextInputV2>
  ...
  return {
    ...
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "fb0ded07-1b48-4e0c-9970-ead30be16e3e",
    kind:
      overrides && overrides.hasOwnProperty("kind")
        ? overrides.kind!
        : FormComponentKind.Checkbox,
    label:
      overrides && overrides.hasOwnProperty("label")
        ...
        : "quis",
    longResponse:
      overrides && overrides.hasOwnProperty("longResponse")
        ? overrides.longResponse!
        : true,
    placeholder:
      overrides && overrides.hasOwnProperty("placeholder")
        ? overrides.placeholder!
...
export const aCustomFormComponentTextV2 = (
  overrides?: Partial<CustomFormComponentTextV2>
  ...
  return {
    ...
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "8994fa92-f6c9-4d93-8634-57548479a655",
    kind:
      overrides && overrides.hasOwnProperty("kind")
        ? overrides.kind!
        : FormComponentKind.Checkbox,
...
export const aCustomFormComponentTextarea = (
  overrides?: Partial<CustomFormComponentTextarea>
): CustomFormComponentTextarea => {
  return {
    h: overrides && overrides.hasOwnProperty("h") ? overrides.h! : 7625,
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "ec292a84-2609-42d6-89a1-58e6e6a598f6",
    kind:
      overrides && overrides.hasOwnProperty("kind")
        ? overrides.kind!
        : FormComponentKind.Checkbox,
    label:
      overrides && overrides.hasOwnProperty("label") ? overrides.label! : "aut",
    placeholder:
      overrides && overrides.hasOwnProperty("placeholder")
        ? overrides.placeholder!
        : "sint",
...
export const aCustomFormImageAnswer = (
  overrides?: Partial<CustomFormImageAnswer>
): CustomFormImageAnswer => {
  return {
    customFormImageId:
      overrides && overrides.hasOwnProperty("customFormImageId")
        ? overrides.customFormImageId!
        : "51e71e0e-8b8e-4c72-8520-885bd7c6b549"
  };
};

export const aCustomFormSignatureAnswer = (
  overrides?: Partial<CustomFormSignatureAnswer>
): CustomFormSignatureAnswer => {
  return {
    fileUploadId:
      overrides && overrides.hasOwnProperty("fileUploadId")
        ? overrides.fileUploadId!
        : "27b21f4a-eb6f-40f9-97a9-cc43895db38b",
    name:
      overrides && overrides.hasOwnProperty("name") ? overrides.name! : "est"
  };
};

export const aCustomFormTemplate = (
  overrides?: Partial<CustomFormTemplate>
): CustomFormTemplate => {
  return {
    active:
    ...
    components:
      overrides && overrides.hasOwnProperty("components")
        ...
        : [aCustomFormComponent()],
    createdByStaff:
      overrides && overrides.hasOwnProperty("createdByStaff")
        ? overrides.createdByStaff!
        : aStaff(),
    currentVersion:
      overrides && overrides.hasOwnProperty("currentVersion")
    ...
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "787caa0d-2a92-4417-b32e-fe56462b5621",
    insertedAt:
      overrides && overrides.hasOwnProperty("insertedAt")
        ? overrides.insertedAt!
        : "quisquam",
    ...
    requestDuringBooking:
      overrides && overrides.hasOwnProperty("requestDuringBooking")
        ? overrides.requestDuringBooking!
        : true,
    requestDuringCheckin:
      overrides && overrides.hasOwnProperty("requestDuringCheckin")
        ? overrides.requestDuringCheckin!
        : true,
    requestDuringReminder:
      overrides && overrides.hasOwnProperty("requestDuringReminder")
        ? overrides.requestDuringReminder!
        : true,
    requestSameDay:
      overrides && overrides.hasOwnProperty("requestSameDay")
        ? overrides.requestSameDay!
        : false,
    resource:
      overrides && overrides.hasOwnProperty("resource")
        ? overrides.resource!
        : FormResourceType.Appointment,
    sortOrder:
      overrides && overrides.hasOwnProperty("sortOrder")
        ? overrides.sortOrder!
        : 0.11,
    status:
      overrides && overrides.hasOwnProperty("status")
        ...
        : "sed",
    templateLocations:
      overrides && overrides.hasOwnProperty("templateLocations")
        ? overrides.templateLocations!
        : [aCustomFormTemplateLocation()],
    templateServices:
      overrides && overrides.hasOwnProperty("templateServices")
        ? overrides.templateServices!
        : [aCustomFormTemplateService()],
    updatedAt:
      overrides && overrides.hasOwnProperty("updatedAt")
        ? overrides.updatedAt!
        : "temporibus"
...
export const aCustomFormTemplateLocation = (
  overrides?: Partial<CustomFormTemplateLocation>
): CustomFormTemplateLocation => {
  return {
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "0774308d-ffd8-4e2a-acef-784cf6323bbc",
    location:
      overrides && overrides.hasOwnProperty("location")
        ? overrides.location!
        : aLocation(),
...
export const aCustomFormTemplateService = (
  overrides?: Partial<CustomFormTemplateService>
): CustomFormTemplateService => {
  return {
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "59ed2d68-5aa7-41b4-b177-8c7d56fe135d",
    service:
      overrides && overrides.hasOwnProperty("service")
        ? overrides.service!
        : aService(),
...
export const aCustomFormVersion = (
  overrides?: Partial<CustomFormVersion>
): CustomFormVersion => {
  return {
    components:
      overrides && overrides.hasOwnProperty("components")
    ...
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "333ccd5d-150d-45fd-8c67-52f9ba789225",
    template:
      overrides && overrides.hasOwnProperty("template")
        ? overrides.template!
        : aCustomFormTemplate(),
    templatingVersion:
      overrides && overrides.hasOwnProperty("templatingVersion")
        ? overrides.templatingVersion!
        : 4607
  };
};

export const aDeleteCartGiftCardItemEmailFulfillmentInput = (
  overrides?: Partial<DeleteCartGiftCardItemEmailFulfillmentInput>
): DeleteCartGiftCardItemEmailFulfillmentInput => {
  return {
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "efff04a9-263c-4776-ab02-e54d829b7913",
    itemId:
      overrides && overrides.hasOwnProperty("itemId")
        ? overrides.itemId!
        : "c8047555-e600-4f4d-86cd-303dfb80edab"
  };
};

export const aDeleteCartGiftCardItemEmailFulfillmentPayload = (
  overrides?: Partial<DeleteCartGiftCardItemEmailFulfillmentPayload>
...
export const aDeleteCartGuestInput = (
  overrides?: Partial<DeleteCartGuestInput>
): DeleteCartGuestInput => {
  return {
    guestId:
      overrides && overrides.hasOwnProperty("guestId")
        ? overrides.guestId!
        : "059a9393-1d00-4710-8353-9709308ac23a",
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "c93b9cd1-a36b-4892-8065-02f0fd45f50b"
  };
};

export const aDeleteCartGuestPayload = (
  overrides?: Partial<DeleteCartGuestPayload>
...
export const aFormComponentCheckboxValue = (
  overrides?: Partial<FormComponentCheckboxValue>
): FormComponentCheckboxValue => {
  return {
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "ba5b7301-81bc-4fe3-a8d7-6d16001a4268",
    label:
      overrides && overrides.hasOwnProperty("label")
        ? overrides.label!
        : "dolores"
...
export const aFormComponentV2CheckboxValue = (
  overrides?: Partial<FormComponentV2CheckboxValue>
): FormComponentV2CheckboxValue => {
  return {
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "d03dddd9-2de7-416d-ae1c-00d653172a2b",
    label:
      overrides && overrides.hasOwnProperty("label")
        ? overrides.label!
        : "quisquam"
...
export const aFormTemplate = (
  ...
  return {
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "5b41abee-e480-4954-8b23-bf9879ad7eef",
    name:
      overrides && overrides.hasOwnProperty("name") ? overrides.name! : "animi"
  };
};

export const aGiftCardDesign = (
  overrides?: Partial<GiftCardDesign>
): GiftCardDesign => {
  return {
    backgroundColor:
      overrides && overrides.hasOwnProperty("backgroundColor")
    ...
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "f216822a-9565-403c-a951-481344cfba48",
    image:
    ...
    preset:
      overrides && overrides.hasOwnProperty("preset")
        ? overrides.preset!
        : false
  };
};
  ...
  return {
    address:
      overrides && overrides.hasOwnProperty("address")
        ...
        : anAddress(),
    allowOnlineBooking:
      overrides && overrides.hasOwnProperty("allowOnlineBooking")
        ? overrides.allowOnlineBooking!
        : false,
    allowOnlineRescheduling:
      overrides && overrides.hasOwnProperty("allowOnlineRescheduling")
        ? overrides.allowOnlineRescheduling!
        : true,
    arrivalInstructions:
      overrides && overrides.hasOwnProperty("arrivalInstructions")
        ? overrides.arrivalInstructions!
        : "iste",
    avatar:
      overrides && overrides.hasOwnProperty("avatar")
        ? overrides.avatar!
        : "aut",
    businessName:
      overrides && overrides.hasOwnProperty("businessName")
        ? overrides.businessName!
        : "dolores",
    contactEmail:
      overrides && overrides.hasOwnProperty("contactEmail")
    ...
    externalId:
      overrides && overrides.hasOwnProperty("externalId")
        ...
        : "ratione",
    hours:
      overrides && overrides.hasOwnProperty("hours")
        ? overrides.hours!
        : [aLocationDays()],
    id:
      overrides && overrides.hasOwnProperty("id")
    ...
    insertedAt:
      overrides && overrides.hasOwnProperty("insertedAt")
        ...
        : "vitae",
    isRemote:
      overrides && overrides.hasOwnProperty("isRemote")
        ? overrides.isRemote!
        : true,
    name:
    ...
    phoneNumber:
      overrides && overrides.hasOwnProperty("phoneNumber")
        ...
        : "et",
    social:
      overrides && overrides.hasOwnProperty("social")
        ? overrides.social!
        : aLocationSocialAccounts(),
    tz:
      overrides && overrides.hasOwnProperty("tz")
        ? overrides.tz!
        : "consectetur",
...
export const aLocationDays = (
  overrides?: Partial<LocationDays>
): LocationDays => {
  return {
    finish:
      overrides && overrides.hasOwnProperty("finish")
        ? overrides.finish!
        : aLocationHours(),
    open:
      overrides && overrides.hasOwnProperty("open") ? overrides.open! : false,
    start:
      overrides && overrides.hasOwnProperty("start")
        ? overrides.start!
        : aLocationHours()
  };
};
...
export const aLocationHours = (
  overrides?: Partial<LocationHours>
): LocationHours => {
  return {
    hour:
      overrides && overrides.hasOwnProperty("hour") ? overrides.hour! : 6283,
    minute:
      overrides && overrides.hasOwnProperty("minute") ? overrides.minute! : 1255
  };
};

export const aLocationSocialAccounts = (
  overrides?: Partial<LocationSocialAccounts>
): LocationSocialAccounts => {
  return {
    facebook:
      overrides && overrides.hasOwnProperty("facebook")
        ? overrides.facebook!
        : "laudantium",
    google:
      overrides && overrides.hasOwnProperty("google")
        ? overrides.google!
        : "aut",
    instagram:
      overrides && overrides.hasOwnProperty("instagram")
        ? overrides.instagram!
        : "eveniet",
    pinterest:
      overrides && overrides.hasOwnProperty("pinterest")
        ? overrides.pinterest!
        : "omnis",
    twitter:
      overrides && overrides.hasOwnProperty("twitter")
        ...
        : "aut",
    yelp:
      overrides && overrides.hasOwnProperty("yelp")
        ? overrides.yelp!
        : "recusandae",
    youtube:
      overrides && overrides.hasOwnProperty("youtube")
        ? overrides.youtube!
        : "soluta"
  };
};
...
export const aMembership = (overrides?: Partial<Membership>): Membership => {
  return {
    ...
    clientId:
      overrides && overrides.hasOwnProperty("clientId")
        ? overrides.clientId!
        : "4a0aac29-d66f-41b4-a7dc-ca42db940921",
    creditCard:
      overrides && overrides.hasOwnProperty("creditCard")
        ? overrides.creditCard!
        : aCreditCard(),
    currentBillingError:
      overrides && overrides.hasOwnProperty("currentBillingError")
        ? overrides.currentBillingError!
        : false,
    endOn:
      overrides && overrides.hasOwnProperty("endOn")
        ? overrides.endOn!
        : "2003-03-23",
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "cf18c1f2-8e7d-4a3d-a70d-a877d24df604",
    interval:
      overrides && overrides.hasOwnProperty("interval")
        ? overrides.interval!
        : "laboriosam",
    name:
      overrides && overrides.hasOwnProperty("name") ? overrides.name! : "ut",
    ...
    termNumber:
      overrides && overrides.hasOwnProperty("termNumber")
        ? overrides.termNumber!
        : 5333,
    unitPrice:
      overrides && overrides.hasOwnProperty("unitPrice")
        ...
        : "facilis",
    vouchers:
      overrides && overrides.hasOwnProperty("vouchers")
        ? overrides.vouchers!
        : [aMembershipVoucher()]
  };
};

export const aMembershipConnection = (
  overrides?: Partial<MembershipConnection>
...
export const aMembershipEdge = (
  overrides?: Partial<MembershipEdge>
): MembershipEdge => {
  return {
    cursor:
      overrides && overrides.hasOwnProperty("cursor")
...
export const aMembershipPaymentMethodUpdateAndRenewInput = (
  overrides?: Partial<MembershipPaymentMethodUpdateAndRenewInput>
): MembershipPaymentMethodUpdateAndRenewInput => {
  return {
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "a1fe8d15-4331-497f-b0fe-7b450acb2485",
    paymentMethodId:
      overrides && overrides.hasOwnProperty("paymentMethodId")
        ? overrides.paymentMethodId!
        : "4e1eb3a3-84d5-42d7-82d6-be5b6f039b8b"
  };
};

export const aMembershipPaymentMethodUpdateAndRenewPayload = (
  overrides?: Partial<MembershipPaymentMethodUpdateAndRenewPayload>
): MembershipPaymentMethodUpdateAndRenewPayload => {
  return {
    membership:
      overrides && overrides.hasOwnProperty("membership")
        ? overrides.membership!
        : aMembership(),
    newCardWasChargedForRenewal:
      overrides && overrides.hasOwnProperty("newCardWasChargedForRenewal")
        ? overrides.newCardWasChargedForRenewal!
        : true
  };
};

export const aMembershipPaymentMethodUpdateInput = (
  overrides?: Partial<MembershipPaymentMethodUpdateInput>
): MembershipPaymentMethodUpdateInput => {
  return {
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "8aca7170-dffb-4af0-b26e-e01d1f916d0c",
    paymentMethodId:
      overrides && overrides.hasOwnProperty("paymentMethodId")
        ? overrides.paymentMethodId!
        : "b5650405-a414-4d6d-9a1a-aa9b2722228e"
  };
};

export const aMembershipPaymentMethodUpdatePayload = (
  overrides?: Partial<MembershipPaymentMethodUpdatePayload>
...
export const aMembershipVoucher = (
  overrides?: Partial<MembershipVoucher>
): MembershipVoucher => {
  return {
    quantity:
...
export const anOnlineGiftCardSettings = (
  overrides?: Partial<OnlineGiftCardSettings>
): OnlineGiftCardSettings => {
  return {
    giftCardDesigns:
      overrides && overrides.hasOwnProperty("giftCardDesigns")
        ? overrides.giftCardDesigns!
        : [aBusinessGiftCardDesign()],
    designatedLocationId:
      overrides && overrides.hasOwnProperty("designatedLocationId")
        ? overrides.designatedLocationId!
        : "696ad8e2-21ba-4718-aea9-263e362c84d5",
    websiteMessage:
      overrides && overrides.hasOwnProperty("websiteMessage")
        ? overrides.websiteMessage!
        : "beatae"
  };
};
...
export const aReferralInput = (
  overrides?: Partial<ReferralInput>
): ReferralInput => {
  return {
    additionalInfo:
      overrides && overrides.hasOwnProperty("additionalInfo")
        ? overrides.additionalInfo!
        : "sunt",
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "1c1b11a6-7ea7-4bd5-9adc-adedc5f6eb17",
    referralSourceId:
      overrides && overrides.hasOwnProperty("referralSourceId")
        ? overrides.referralSourceId!
        : "42dfadb4-7e61-4689-955e-bfbdb8f14409",
    referrerClientId:
      overrides && overrides.hasOwnProperty("referrerClientId")
        ? overrides.referrerClientId!
        : "df211b0e-130e-4ea7-9b93-2d370c9185d5"
  };
};

export const aReferralSource = (
  overrides?: Partial<ReferralSource>
): ReferralSource => {
  return {
    active:
      overrides && overrides.hasOwnProperty("active")
        ...
        : false,
    allLocations:
      overrides && overrides.hasOwnProperty("allLocations")
        ? overrides.allLocations!
        : true,
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "c29cd158-2b24-442f-8c2d-afdd3408ee81",
    insertedAt:
      overrides && overrides.hasOwnProperty("insertedAt")
        ? overrides.insertedAt!
        : "veniam",
    locationId:
      overrides && overrides.hasOwnProperty("locationId")
        ? overrides.locationId!
        : "f170a5e6-cf32-4bf0-9983-ccad336f135e",
    locations:
      overrides && overrides.hasOwnProperty("locations")
        ? overrides.locations!
        : [aLocation()],
    name:
      overrides && overrides.hasOwnProperty("name") ? overrides.name! : "quae"
  };
};

export const aRemoveCartOfferInput = (
  overrides?: Partial<RemoveCartOfferInput>
): RemoveCartOfferInput => {
  return {
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "9a4d2ad1-1087-4111-9036-0a16fe84b8a6",
    offerId:
      overrides && overrides.hasOwnProperty("offerId")
        ? overrides.offerId!
        : "nesciunt"
  };
};

export const aRemoveCartOfferPayload = (
  overrides?: Partial<RemoveCartOfferPayload>
...
export const aRemoveCartSelectedItemInput = (
  overrides?: Partial<RemoveCartSelectedItemInput>
): RemoveCartSelectedItemInput => {
  return {
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "d34eb42f-4dac-4a57-8655-f6e21e922e91",
    itemId:
      overrides && overrides.hasOwnProperty("itemId")
        ? overrides.itemId!
        : "3df818b1-8c01-4e3b-9f18-4dd7b9f15380"
  };
};

export const aRemoveCartSelectedItemPayload = (
  overrides?: Partial<RemoveCartSelectedItemPayload>
...
export const aRemoveCustomFormImageResult = (
  overrides?: Partial<RemoveCustomFormImageResult>
): RemoveCustomFormImageResult => {
  return {
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "67063e94-922d-4176-8394-f5ed407d65fa"
  };
};

export const aRequestCodeInput = (
  overrides?: Partial<RequestCodeInput>
): RequestCodeInput => {
  return {
    method:
...
export const aRequestCodePayload = (
  overrides?: Partial<RequestCodePayload>
): RequestCodePayload => {
  return {
    requestId:
      overrides && overrides.hasOwnProperty("requestId")
        ? overrides.requestId!
        : "quia"
  };
};

export const aReserveCartBookableItemsInput = (
  overrides?: Partial<ReserveCartBookableItemsInput>
): ReserveCartBookableItemsInput => {
  return {
    bookableTimeId:
      overrides && overrides.hasOwnProperty("bookableTimeId")
        ? overrides.bookableTimeId!
        : "b487e0e3-3bd3-4086-b742-d4dd05c07e58",
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "711f5c8b-80ad-4f8f-9d2e-4e3e7264bcf9"
  };
};

export const aReserveCartBookableItemsPayload = (
  overrides?: Partial<ReserveCartBookableItemsPayload>
...
export const aRootMutationType = (
  overrides?: Partial<RootMutationType>
): RootMutationType => {
  return {
    addCartCardPaymentMethod:
      overrides && overrides.hasOwnProperty("addCartCardPaymentMethod")
        ? overrides.addCartCardPaymentMethod!
        : anAddCartCardPaymentMethodPayload(),
    addCartOffer:
      overrides && overrides.hasOwnProperty("addCartOffer")
        ? overrides.addCartOffer!
        : anAddCartOfferPayload(),
    addCartSelectedBookableItem:
      overrides && overrides.hasOwnProperty("addCartSelectedBookableItem")
        ? overrides.addCartSelectedBookableItem!
        : anAddCartSelectedBookableItemPayload(),
    addCartSelectedGiftCardItem:
      overrides && overrides.hasOwnProperty("addCartSelectedGiftCardItem")
        ? overrides.addCartSelectedGiftCardItem!
        : anAddCartSelectedGiftCardItemPayload(),
    addCartSelectedPurchasableItem:
      overrides && overrides.hasOwnProperty("addCartSelectedPurchasableItem")
        ? overrides.addCartSelectedPurchasableItem!
        : anAddCartSelectedPurchasableItemPayload(),
    appointmentAddTags:
      overrides && overrides.hasOwnProperty("appointmentAddTags")
        ? overrides.appointmentAddTags!
        : anAppointmentAddTagsPayload(),
    appointmentReschedule:
      overrides && overrides.hasOwnProperty("appointmentReschedule")
        ? overrides.appointmentReschedule!
        : anAppointmentReschedulePayload(),
    appointmentRescheduleAvailableDates:
      overrides &&
      overrides.hasOwnProperty("appointmentRescheduleAvailableDates")
        ? overrides.appointmentRescheduleAvailableDates!
        : anAppointmentRescheduleAvailableDatesPayload(),
    appointmentRescheduleAvailableTimes:
      overrides &&
      overrides.hasOwnProperty("appointmentRescheduleAvailableTimes")
        ? overrides.appointmentRescheduleAvailableTimes!
        : anAppointmentRescheduleAvailableTimesPayload(),
    cancelAppointment:
      overrides && overrides.hasOwnProperty("cancelAppointment")
        ? overrides.cancelAppointment!
        : aCancelAppointmentPayload(),
    cartAddToWaitlist:
      overrides && overrides.hasOwnProperty("cartAddToWaitlist")
        ? overrides.cartAddToWaitlist!
        : aCartAddToWaitlistPayload(),
    cartBookingQuestionAddAnswer:
      overrides && overrides.hasOwnProperty("cartBookingQuestionAddAnswer")
        ? overrides.cartBookingQuestionAddAnswer!
        : aCartBookingQuestionAddAnswerPayload(),
    cartBookingQuestionClearAnswer:
      overrides && overrides.hasOwnProperty("cartBookingQuestionClearAnswer")
        ? overrides.cartBookingQuestionClearAnswer!
        : aCartBookingQuestionClearAnswerPayload(),
    cartClear:
      overrides && overrides.hasOwnProperty("cartClear")
        ? overrides.cartClear!
        : aCartClearPayload(),
    cartSetLocation:
      overrides && overrides.hasOwnProperty("cartSetLocation")
        ? overrides.cartSetLocation!
        : aCartSetLocationPayload(),
    checkoutCart:
      overrides && overrides.hasOwnProperty("checkoutCart")
        ? overrides.checkoutCart!
        : aCheckoutCartPayload(),
    confirmAppointment:
      overrides && overrides.hasOwnProperty("confirmAppointment")
        ? overrides.confirmAppointment!
        : aConfirmAppointmentPayload(),
    createCart:
      overrides && overrides.hasOwnProperty("createCart")
        ? overrides.createCart!
        : aCreateCartPayload(),
    createCartGiftCardItemEmailFulfillment:
      overrides &&
      overrides.hasOwnProperty("createCartGiftCardItemEmailFulfillment")
        ? overrides.createCartGiftCardItemEmailFulfillment!
        : aCreateCartGiftCardItemEmailFulfillmentPayload(),
    createCartGuest:
      overrides && overrides.hasOwnProperty("createCartGuest")
        ? overrides.createCartGuest!
        : aCreateCartGuestPayload(),
    createClientNote:
      overrides && overrides.hasOwnProperty("createClientNote")
        ? overrides.createClientNote!
        : aCreateClientNotePayload(),
    createCreditCard:
      overrides && overrides.hasOwnProperty("createCreditCard")
        ? overrides.createCreditCard!
        : aCreateCreditCardResult(),
    createCustomForm:
      overrides && overrides.hasOwnProperty("createCustomForm")
        ? overrides.createCustomForm!
        : aCustomForm(),
    deleteCartGiftCardItemEmailFulfillment:
      overrides &&
      overrides.hasOwnProperty("deleteCartGiftCardItemEmailFulfillment")
        ? overrides.deleteCartGiftCardItemEmailFulfillment!
        : aDeleteCartGiftCardItemEmailFulfillmentPayload(),
    deleteCartGuest:
      overrides && overrides.hasOwnProperty("deleteCartGuest")
        ? overrides.deleteCartGuest!
        : aDeleteCartGuestPayload(),
    membershipPaymentMethodUpdate:
      overrides && overrides.hasOwnProperty("membershipPaymentMethodUpdate")
        ? overrides.membershipPaymentMethodUpdate!
        : aMembershipPaymentMethodUpdatePayload(),
    membershipPaymentMethodUpdateAndRenew:
      overrides &&
      overrides.hasOwnProperty("membershipPaymentMethodUpdateAndRenew")
        ? overrides.membershipPaymentMethodUpdateAndRenew!
        : aMembershipPaymentMethodUpdateAndRenewPayload(),
    removeCartOffer:
      overrides && overrides.hasOwnProperty("removeCartOffer")
        ? overrides.removeCartOffer!
        : aRemoveCartOfferPayload(),
    removeCartSelectedItem:
      overrides && overrides.hasOwnProperty("removeCartSelectedItem")
        ? overrides.removeCartSelectedItem!
        : aRemoveCartSelectedItemPayload(),
    removeCustomFormImage:
      overrides && overrides.hasOwnProperty("removeCustomFormImage")
        ? overrides.removeCustomFormImage!
        : aRemoveCustomFormImageResult(),
    requestCode:
      overrides && overrides.hasOwnProperty("requestCode")
        ? overrides.requestCode!
        : aRequestCodePayload(),
    reserveCartBookableItems:
      overrides && overrides.hasOwnProperty("reserveCartBookableItems")
        ? overrides.reserveCartBookableItems!
        : aReserveCartBookableItemsPayload(),
    selectCartPaymentMethod:
      overrides && overrides.hasOwnProperty("selectCartPaymentMethod")
        ? overrides.selectCartPaymentMethod!
        : aSelectCartPaymentMethodPayload(),
    sendCartOwnershipCodeByEmail:
      overrides && overrides.hasOwnProperty("sendCartOwnershipCodeByEmail")
        ? overrides.sendCartOwnershipCodeByEmail!
        : aSendCartOwnershipCodeByEmailPayload(),
    sendCartOwnershipCodeBySms:
      overrides && overrides.hasOwnProperty("sendCartOwnershipCodeBySms")
        ? overrides.sendCartOwnershipCodeBySms!
        : aSendCartOwnershipCodeBySmsPayload(),
    startCustomFormImageUpload:
      overrides && overrides.hasOwnProperty("startCustomFormImageUpload")
        ? overrides.startCustomFormImageUpload!
        : aStartCustomFormImageUploadResult(),
    takeCartOwnership:
      overrides && overrides.hasOwnProperty("takeCartOwnership")
        ? overrides.takeCartOwnership!
        : aTakeCartOwnershipPayload(),
    takeCartOwnershipByCode:
      overrides && overrides.hasOwnProperty("takeCartOwnershipByCode")
        ? overrides.takeCartOwnershipByCode!
        : aTakeCartOwnershipByCodePayload(),
    unstableClientPasswordlessAuthRequestCode:
      overrides &&
      overrides.hasOwnProperty("unstableClientPasswordlessAuthRequestCode")
        ? overrides.unstableClientPasswordlessAuthRequestCode!
        : anUnstableClientPasswordlessAuthRequestCodePayload(),
    unstableClientPasswordlessAuthSignIn:
      overrides &&
      overrides.hasOwnProperty("unstableClientPasswordlessAuthSignIn")
        ? overrides.unstableClientPasswordlessAuthSignIn!
        : anUnstableClientPasswordlessAuthSignInPayload(),
    updateCart:
      overrides && overrides.hasOwnProperty("updateCart")
        ? overrides.updateCart!
        : anUpdateCartPayload(),
    updateCartGiftCardItemEmailFulfillment:
      overrides &&
      overrides.hasOwnProperty("updateCartGiftCardItemEmailFulfillment")
        ? overrides.updateCartGiftCardItemEmailFulfillment!
        : anUpdateCartGiftCardItemEmailFulfillmentPayload(),
    updateCartGuest:
      overrides && overrides.hasOwnProperty("updateCartGuest")
        ? overrides.updateCartGuest!
        : anUpdateCartGuestPayload(),
    updateCartSelectedBookableItem:
      overrides && overrides.hasOwnProperty("updateCartSelectedBookableItem")
        ? overrides.updateCartSelectedBookableItem!
        : anUpdateCartSelectedBookableItemPayload(),
    updateCartSelectedGiftCardItem:
      overrides && overrides.hasOwnProperty("updateCartSelectedGiftCardItem")
        ? overrides.updateCartSelectedGiftCardItem!
        : anUpdateCartSelectedGiftCardItemPayload(),
    updateCartSelectedPurchasableItem:
      overrides && overrides.hasOwnProperty("updateCartSelectedPurchasableItem")
        ? overrides.updateCartSelectedPurchasableItem!
        : anUpdateCartSelectedPurchasableItemPayload(),
    updateClient:
      overrides && overrides.hasOwnProperty("updateClient")
        ? overrides.updateClient!
        : anUpdateClientPayload(),
    updateClientInfo:
      overrides && overrides.hasOwnProperty("updateClientInfo")
        ? overrides.updateClientInfo!
        : anUpdateClientInfoPayload(),
    updateCommunicationSubscriptions:
      overrides && overrides.hasOwnProperty("updateCommunicationSubscriptions")
        ? overrides.updateCommunicationSubscriptions!
        : anUpdateCommunicationSubscriptionsPayload(),
    updateCustomForm:
      overrides && overrides.hasOwnProperty("updateCustomForm")
        ? overrides.updateCustomForm!
        : aCustomForm()
  };
};

export const aRootQueryType = (
  ...
  return {
    appointment:
      overrides && overrides.hasOwnProperty("appointment")
        ...
        : anAppointment(),
    business:
      overrides && overrides.hasOwnProperty("business")
        ? overrides.business!
        : aBusiness(),
    cart:
      overrides && overrides.hasOwnProperty("cart") ? overrides.cart! : aCart(),
    cartBookableDates:
      overrides && overrides.hasOwnProperty("cartBookableDates")
        ? overrides.cartBookableDates!
        : [aCartBookableDate()],
    cartBookableStaffVariants:
      overrides && overrides.hasOwnProperty("cartBookableStaffVariants")
        ? overrides.cartBookableStaffVariants!
        : [aCartAvailableBookableItemStaffVariant()],
    cartBookableTimes:
      overrides && overrides.hasOwnProperty("cartBookableTimes")
        ? overrides.cartBookableTimes!
        : [aCartBookableTime()],
    client:
      overrides && overrides.hasOwnProperty("client")
        ? overrides.client!
        : aClient(),
    customForm:
      overrides && overrides.hasOwnProperty("customForm")
        ? overrides.customForm!
        : aCustomForm(),
    customFormTemplate:
      overrides && overrides.hasOwnProperty("customFormTemplate")
        ? overrides.customFormTemplate!
        : aCustomFormTemplate(),
    locations:
      overrides && overrides.hasOwnProperty("locations")
        ? overrides.locations!
    ...
    membership:
      overrides && overrides.hasOwnProperty("membership")
        ...
        : aMembership(),
    myAppointments:
      overrides && overrides.hasOwnProperty("myAppointments")
        ? overrides.myAppointments!
        : anAppointmentConnection(),
    myCreditCards:
      overrides && overrides.hasOwnProperty("myCreditCards")
        ? overrides.myCreditCards!
        : aCreditCardConnection(),
    myMemberships:
      overrides && overrides.hasOwnProperty("myMemberships")
        ? overrides.myMemberships!
        : aMembershipConnection(),
    node:
      overrides && overrides.hasOwnProperty("node") ? overrides.node! : aNode(),
    unstableClientPasswordlessAuthMethods:
      overrides &&
      overrides.hasOwnProperty("unstableClientPasswordlessAuthMethods")
        ? overrides.unstableClientPasswordlessAuthMethods!
        : [anAuthMethod()]
  };
};

export const aSelectCartPaymentMethodInput = (
  overrides?: Partial<SelectCartPaymentMethodInput>
): SelectCartPaymentMethodInput => {
  return {
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "0fab5fe7-3823-4b10-9609-8d1e7976eaa2",
    paymentMethodId:
      overrides && overrides.hasOwnProperty("paymentMethodId")
        ? overrides.paymentMethodId!
        : "206eb754-4551-4447-8058-06166b2c6ad9"
  };
};

export const aSelectCartPaymentMethodPayload = (
  overrides?: Partial<SelectCartPaymentMethodPayload>
...
export const aSendCartOwnershipCodeByEmailInput = (
  overrides?: Partial<SendCartOwnershipCodeByEmailInput>
...
export const aSendCartOwnershipCodeByEmailPayload = (
  overrides?: Partial<SendCartOwnershipCodeByEmailPayload>
): SendCartOwnershipCodeByEmailPayload => {
  return {
    cartOwnershipCodeId:
      overrides && overrides.hasOwnProperty("cartOwnershipCodeId")
        ? overrides.cartOwnershipCodeId!
        : "ex"
  };
};

export const aSendCartOwnershipCodeBySmsInput = (
  overrides?: Partial<SendCartOwnershipCodeBySmsInput>
...
export const aSendCartOwnershipCodeBySmsPayload = (
  overrides?: Partial<SendCartOwnershipCodeBySmsPayload>
): SendCartOwnershipCodeBySmsPayload => {
  return {
    cartOwnershipCodeId:
      overrides && overrides.hasOwnProperty("cartOwnershipCodeId")
  ...
  return {
    category:
      overrides && overrides.hasOwnProperty("category")
        ...
        : aServiceCategory(),
    categoryId:
      overrides && overrides.hasOwnProperty("categoryId")
        ? overrides.categoryId!
        : "62102480-3a97-4660-8b44-8524cfe48edb",
    description:
      overrides && overrides.hasOwnProperty("description")
        ? overrides.description!
        : "eos",
    ...
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "4da70d2c-0d44-4b8e-8e3c-80708e0d1d25",
    name:
      overrides && overrides.hasOwnProperty("name")
        ? overrides.name!
        : "cupiditate"
...
export const aServiceOption = (
  overrides?: Partial<ServiceOption>
): ServiceOption => {
  return {
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "9b954ffe-61d4-4141-9609-be016441d917",
    name:
      overrides && overrides.hasOwnProperty("name")
        ? overrides.name!
        : "perspiciatis"
...
export const aStaff = (overrides?: Partial<Staff>): Staff => {
  return {
    ...
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "24717f91-afa7-4612-84c0-a376de64660f",
    insertedAt:
      overrides && overrides.hasOwnProperty("insertedAt")
        ? overrides.insertedAt!
        : "et",
...
export const aStaffRole = (overrides?: Partial<StaffRole>): StaffRole => {
  return {
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "c88906d2-2ada-4a17-a562-e32531579e4f",
    name:
      overrides && overrides.hasOwnProperty("name") ? overrides.name! : "nemo"
  };
};

export const aStartCustomFormImageUploadInput = (
  overrides?: Partial<StartCustomFormImageUploadInput>
  ...
  return {
    ...
    locationId:
      overrides && overrides.hasOwnProperty("locationId")
        ? overrides.locationId!
        : "9477c76d-29fe-431c-ac7e-aff7eb47f4ba"
  };
};

export const aStartCustomFormImageUploadResult = (
  overrides?: Partial<StartCustomFormImageUploadResult>
): StartCustomFormImageUploadResult => {
  return {
    customFormImageId:
      overrides && overrides.hasOwnProperty("customFormImageId")
        ? overrides.customFormImageId!
        : "f90d1d1f-6e3d-4ad6-acfc-f36d19913ca3",
    signedPutUrl:
      overrides && overrides.hasOwnProperty("signedPutUrl")
        ? overrides.signedPutUrl!
        : "sit"
...
export const aTakeCartOwnershipByCodeInput = (
  overrides?: Partial<TakeCartOwnershipByCodeInput>
  ...
  return {
    ...
    cartOwnershipCodeValue:
      overrides && overrides.hasOwnProperty("cartOwnershipCodeValue")
        ? overrides.cartOwnershipCodeValue!
        : 8421
  };
};

export const aTakeCartOwnershipByCodePayload = (
  overrides?: Partial<TakeCartOwnershipByCodePayload>
...
export const aTakeCartOwnershipInput = (
  overrides?: Partial<TakeCartOwnershipInput>
): TakeCartOwnershipInput => {
  return {
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "19bbe242-ec7a-469b-bc42-ce0a8e6f7030"
  };
};

export const aTakeCartOwnershipPayload = (
  overrides?: Partial<TakeCartOwnershipPayload>
...
export const anUnstableClientPasswordlessAuthRequestCodeInput = (
  overrides?: Partial<UnstableClientPasswordlessAuthRequestCodeInput>
): UnstableClientPasswordlessAuthRequestCodeInput => {
  return {
    methodId:
      overrides && overrides.hasOwnProperty("methodId")
        ? overrides.methodId!
        : "dolores"
  };
};

export const anUnstableClientPasswordlessAuthRequestCodePayload = (
  overrides?: Partial<UnstableClientPasswordlessAuthRequestCodePayload>
): UnstableClientPasswordlessAuthRequestCodePayload => {
  return {
    requestId:
      overrides && overrides.hasOwnProperty("requestId")
        ? overrides.requestId!
...
export const anUnstableClientPasswordlessAuthSignInInput = (
  overrides?: Partial<UnstableClientPasswordlessAuthSignInInput>
): UnstableClientPasswordlessAuthSignInInput => {
  return {
    code:
      overrides && overrides.hasOwnProperty("code") ? overrides.code! : 8439,
    requestId:
      overrides && overrides.hasOwnProperty("requestId")
        ? overrides.requestId!
        : "minima"
...
export const anUnstableClientPasswordlessAuthSignInPayload = (
  overrides?: Partial<UnstableClientPasswordlessAuthSignInPayload>
): UnstableClientPasswordlessAuthSignInPayload => {
  return {
    client:
      overrides && overrides.hasOwnProperty("client")
        ? overrides.client!
...
export const anUpdateCartGiftCardItemEmailFulfillmentInput = (
  overrides?: Partial<UpdateCartGiftCardItemEmailFulfillmentInput>
  ...
  return {
    ...
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "b3e62c7c-9973-4340-bb9c-72e10ae0591e",
    itemId:
      overrides && overrides.hasOwnProperty("itemId")
        ? overrides.itemId!
        : "f524d9d4-f5ea-4b0f-bf95-8d6320dd2946",
    messageFromSender:
      overrides && overrides.hasOwnProperty("messageFromSender")
        ? overrides.messageFromSender!
        : "et",
...
export const anUpdateCartGiftCardItemEmailFulfillmentPayload = (
  overrides?: Partial<UpdateCartGiftCardItemEmailFulfillmentPayload>
...
export const anUpdateCartGuestInput = (
  overrides?: Partial<UpdateCartGuestInput>
  ...
  return {
    ...
    guestId:
      overrides && overrides.hasOwnProperty("guestId")
        ? overrides.guestId!
        : "cb5eebcf-a30a-4d09-abec-f439fea943d8",
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "eb0d6378-f765-4197-997a-20cad038dcfd",
    lastName:
      overrides && overrides.hasOwnProperty("lastName")
        ? overrides.lastName!
        : "beatae",
...
export const anUpdateCartGuestPayload = (
  overrides?: Partial<UpdateCartGuestPayload>
...
export const anUpdateCartInput = (
  overrides?: Partial<UpdateCartInput>
): UpdateCartInput => {
  return {
    advanceGratuity:
      overrides && overrides.hasOwnProperty("advanceGratuity")
    ...
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "46f98543-1d9a-4871-98a0-aa97b3366e4f",
    referralSource:
      overrides && overrides.hasOwnProperty("referralSource")
        ? overrides.referralSource!
        : "velit"
...
export const anUpdateCartPayload = (
...
export const anUpdateCartSelectedBookableItemInput = (
  overrides?: Partial<UpdateCartSelectedBookableItemInput>
): UpdateCartSelectedBookableItemInput => {
  return {
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "0af2c74a-f9ae-482c-9cc3-776a2824ec0d",
    itemDiscountCode:
      overrides && overrides.hasOwnProperty("itemDiscountCode")
        ? overrides.itemDiscountCode!
        : "neque",
    itemGuestId:
      overrides && overrides.hasOwnProperty("itemGuestId")
        ? overrides.itemGuestId!
        : "7c2f6e06-6e70-41d1-b2ba-7295fd287a08",
    itemId:
      overrides && overrides.hasOwnProperty("itemId")
        ? overrides.itemId!
        : "07e9a6ee-27e1-499e-a6a9-d4def7aa8c79",
    itemOptionIds:
      overrides && overrides.hasOwnProperty("itemOptionIds")
        ? overrides.itemOptionIds!
        : ["19d9ea5a-93e1-421a-9e00-69133d86bd8c"],
    itemStaffVariantId:
      overrides && overrides.hasOwnProperty("itemStaffVariantId")
        ? overrides.itemStaffVariantId!
        : "5d97de0a-124e-49f3-937e-6f7d7b8a213b"
  };
};

export const anUpdateCartSelectedBookableItemPayload = (
  overrides?: Partial<UpdateCartSelectedBookableItemPayload>
...
export const anUpdateCartSelectedGiftCardItemInput = (
  overrides?: Partial<UpdateCartSelectedGiftCardItemInput>
): UpdateCartSelectedGiftCardItemInput => {
  return {
    giftCardDesignId:
      overrides && overrides.hasOwnProperty("giftCardDesignId")
        ? overrides.giftCardDesignId!
        : "f95ed4b8-b4b6-49c1-930d-d3653ec41ef0",
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "39b8c15a-be2a-4fde-95e4-584419b113d3",
    itemId:
      overrides && overrides.hasOwnProperty("itemId")
        ? overrides.itemId!
        : "b9cf453c-bdad-4e7d-8b28-47c9f349c120",
    itemPrice:
      overrides && overrides.hasOwnProperty("itemPrice")
        ? overrides.itemPrice!
        : "molestias"
...
export const anUpdateCartSelectedGiftCardItemPayload = (
  overrides?: Partial<UpdateCartSelectedGiftCardItemPayload>
...
export const anUpdateCartSelectedPurchasableItemInput = (
  overrides?: Partial<UpdateCartSelectedPurchasableItemInput>
): UpdateCartSelectedPurchasableItemInput => {
  return {
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "a1d8f63f-165e-483c-af52-9dae3d287c84",
    itemDiscountCode:
      overrides && overrides.hasOwnProperty("itemDiscountCode")
        ? overrides.itemDiscountCode!
        : "dolorem",
    itemId:
      overrides && overrides.hasOwnProperty("itemId")
        ? overrides.itemId!
        : "cf175864-dc59-4373-9d96-55c99bbeacfb"
  };
};

export const anUpdateCartSelectedPurchasableItemPayload = (
  overrides?: Partial<UpdateCartSelectedPurchasableItemPayload>
...
export const anUpdateClientInfoInput = (
  overrides?: Partial<UpdateClientInfoInput>
  ...
  return {
    ...
    emergencyContactName:
      overrides && overrides.hasOwnProperty("emergencyContactName")
        ? overrides.emergencyContactName!
        : "autem",
    emergencyContactPhone:
      overrides && overrides.hasOwnProperty("emergencyContactPhone")
        ? overrides.emergencyContactPhone!
        : "doloremque",
    emergencyContactRelationship:
      overrides && overrides.hasOwnProperty("emergencyContactRelationship")
        ? overrides.emergencyContactRelationship!
        : "accusantium",
    pronoun:
      overrides && overrides.hasOwnProperty("pronoun")
        ? overrides.pronoun!
        : "aut",
    referral:
      overrides && overrides.hasOwnProperty("referral")
        ? overrides.referral!
        : aReferralInput()
  };
};

export const anUpdateClientInfoPayload = (
  overrides?: Partial<UpdateClientInfoPayload>
...
export const anUpdateClientInput = (
  overrides?: Partial<UpdateClientInput>
): UpdateClientInput => {
  return {
    dob:
      overrides && overrides.hasOwnProperty("dob")
...
export const anUpdateClientPayload = (
  overrides?: Partial<UpdateClientPayload>
): UpdateClientPayload => {
  return {
    client:
      overrides && overrides.hasOwnProperty("client")
...
export const anUpdateCommunicationSubscriptionsInput = (
  overrides?: Partial<UpdateCommunicationSubscriptionsInput>
): UpdateCommunicationSubscriptionsInput => {
  return {
    communicationSubscriptions:
      overrides && overrides.hasOwnProperty("communicationSubscriptions")
        ? overrides.communicationSubscriptions!
        : [aCommunicationSubscriptionInput()]
  };
};

export const anUpdateCommunicationSubscriptionsPayload = (
  overrides?: Partial<UpdateCommunicationSubscriptionsPayload>
...
export const anUpdateCustomFormInput = (
  overrides?: Partial<UpdateCustomFormInput>
  ...
  return {
    ...
    id:
      overrides && overrides.hasOwnProperty("id")
        ? overrides.id!
        : "6e691389-9f6f-4780-a6f7-2d02333a1294",
    offline:
      overrides && overrides.hasOwnProperty("offline")
        ? overrides.offline!
        : false,
